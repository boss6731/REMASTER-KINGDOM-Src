...
public class MJNCoinRefundInfo {
	...
	public static void do_store(final MJNCoinRefundInfo refund_info) {
		Updator.exec("insert into ncoin_trade_refund set "
				+ "refund_id=?, character_object_id=?, account_name=?, character_name=?, refund_name=?, bank_name=?, bank_account_number=?, ncoin_value=?, is_refund=?, generate_date=?", 
				new Handler() {
					@Override
					public void handle(PreparedStatement pstm) throws Exception {
						int idx = 0;
	...
	public static MJNCoinRefundInfo from_refund_id(final int refund_id) {
		final MJObjectWrapper<MJNCoinRefundInfo> wrapper = new MJObjectWrapper<MJNCoinRefundInfo>();
	...
	private boolean m_is_refund;
	private String m_generate_date;
	private MJNCoinRefundInfo(){}

	@override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("提款 ID: ").append(m_refund_id).append("");")
		sb.append("帳號名稱: ").append(m_account_name).append("\n");
		sb.append("角色名稱: ").append(m_character_name).append("\n");
		sb.append("提款人名稱: ").append(m_refund_name).append("\n");
		sb.append("銀行名稱: ").append(m_bank_name).append("\n");
		sb.append("銀行帳號: ").append(m_bank_account_number).append("\n");
