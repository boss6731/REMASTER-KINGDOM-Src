...
public class MJDShopItem {
	public int         objId;        // 物件ID
	public int         itemId;       // 物品ID
	public String      name;
	public int         invId;        // 背包ID
	public int         count;        // 數量
	public int         price;        // 價格
	public int         iden;         // 物品狀態
	public int         enchant;      // 附魔值
	public int         attr;         // 屬性
	public boolean     isPurchase;   // 出售(false), 購入(true)
	...
	public static MJDShopItem create(L1ItemInstance item, int count, int enchant, int attrenc, int bless, int price, boolean isPurchase){
		MJDShopItem ditem	= new MJDShopItem();
