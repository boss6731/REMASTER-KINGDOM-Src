...
public class MJLFCTrapThorn {
	private L1NpcInstance 	_shadow;
	private L1NpcInstance 	_thorn;
	public MJLFCTrapThorn(L1NpcInstance shadow, L1NpcInstance thorn){
		_shadow 	= shadow;
		_thorn		= thorn;
	}
	
	public MJLFCTrapThorn(int mapId, int x, int y){
		_shadow		= spawn(MJInstanceLoadManager.MIS_SP_THORNSHADOW_ID, mapId, x, y);
		_thorn		= spawn(MJInstanceLoadManager.MIS_SP_THORN_ID, mapId, x, y);
	}
