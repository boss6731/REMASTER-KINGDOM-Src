...
public class MJHttpLoginResponse extends MJHttpResponse {
	...
	public HttpResponse get_response() throws l1j.server.MJWebServer.Dispatcher.MJHttpClosedException {
		...
		if(MJString.isNullOrEmpty(request_mac)) {
			System.out.println(String.format("%s:%d ����ڰ� ������ �α��� �õ��� �߽��ϴ�.", lInfo.get_client_ip(), lInfo.get_client_port()));
		...
		if (Config.Login.UseExConnect) {
			...
			if (reason != MJHddIdChecker.DENIALS_TYPE_NONE
				...
				System.out.println(String.format("�ϵ�� ���� Ŭ���̾�Ʈ ���� ���� : %s, %s, %d", lInfo.get_account(), lInfo.get_hdd_id(), reason));
