...
public class MJHttpLoginInfo {
	...
	public MJEHttpLoginValidation validation() {
		...
		if(clnt != null) {
			try {
				SC_CUSTOM_MSGBOX.do_kick(clnt, String.format("�������� %s �������� ������ �õ��Ͽ� �����մϴ�.", get_account()));
				System.out.println(String.format("[IP:%s]���� %s �������� ������ �õ��Ͽ� �����մϴ�.", get_client_ip(), get_account()));
				clnt.close();
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		// if(���� ����) -> MJEHttpLoginValidation.FAIL_NOT_FOUND_ACCOUNT
		// ���� ���� üũ....������, ���� ����, ���� ����, ��, ��Ÿ �̹� �α��εƴ��� ���
