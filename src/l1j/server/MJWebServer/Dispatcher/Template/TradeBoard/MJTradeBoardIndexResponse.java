...
public class MJTradeBoardIndexResponse extends MJHttpResponse{
	private static String m_page_document;
	public MJTradeBoardIndexResponse(MJHttpRequest request) {
		super(request);
	...
	public HttpResponse get_response() throws l1j.server.MJWebServer.Dispatcher.MJHttpClosedException {
		if (Config.Web.appcenterCacheReset) {
			m_page_document = load_file_string("./appcenter/Adenbuy_index.html");
		}
		...
		params.add(new MJKeyValuePair<String, String>("{PROFILE_URL}", 
				"https://wstatic-cdn.plaync.com/resource/lineage/profile/char" + _user.getClassId() + "_" + (_user.getGender() == 0 ? "m" : "f") + ".png"));
