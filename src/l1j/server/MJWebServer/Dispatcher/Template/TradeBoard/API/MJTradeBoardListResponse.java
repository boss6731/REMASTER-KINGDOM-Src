	...
	private void getTradeBoardInfoList(StringBuilder stringBuilder, int firstNum) {
		...
		try {
			...
			while (rs.next()) {
				...
				if(!tbi.state.equalsIgnoreCase("完成")) {
					stringBuilder.append("<a href=\"/ingame/itemtrade/detail?id="+ tbi.number + "&page=" + pageNum + "\">\n");
				} else {
					stringBuilder.append("<a href=\"\">\n");
				}
				// TODO 在物品交易菜單中的帖文樣式
				stringBuilder.append("<span class=\"line1\" style=\"width:4% !important;\">" + tbi.number + "</span>\n"); //編號
				stringBuilder.append("<span class=\"line2\" style=\"width:16% !important;\">[" + tbi.category + "]</span>\n"); //物品，金幣類型
				stringBuilder.append("<span class=\"line3\" style=\"width:15% !important;\">[" + tbi.state + "]&nbsp;</span>\n"); // 銷售，完成類型
				stringBuilder.append("<span class=\"line4\" style=\"width:40% !important;\">" + tbi.title + "</span>\n");
				if(tbi.item_name.equalsIgnoreCase("金幣")) {
