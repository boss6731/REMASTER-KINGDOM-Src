...
public class MJItemDetailResponse extends MJHttpResponse {
	private static String m_page_document;

	public MJItemDetailResponse(MJHttpRequest request) {
		super(request);
	}
	...
	public HttpResponse get_response() throws l1j.server.MJWebServer.Dispatcher.MJHttpClosedException {
		if (Config.Web.appcenterCacheReset) {
			m_page_document = load_file_string("./appcenter/item_detail.html");
		}
