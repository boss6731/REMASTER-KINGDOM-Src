...
public class MJStatisticResponse extends MJHttpResponse{
	...
	public HttpResponse get_response() throws l1j.server.MJWebServer.Dispatcher.MJHttpClosedException {
		...
		statistic.marketPriceSummary.itemPriceSummary.lowestPrice = "1만2,000";
		statistic.marketPriceSummary.itemPriceSummary.highestPrice = "54만8,098";
		...
		statistic.marketPriceSummary.itemStatisticSummary.highestPrice = "59만5,814";
		statistic.marketPriceSummary.itemStatisticSummary.averagePrice = "19만4,884";
		...
		for(int i=0; i<5; ++i){
			...
			detail.tradeUser.traderName = String.format("메티스%d", i);
			detail.tradeUser.district = new MJDistrict();
			detail.tradeUser.district.displayName = "중앙구역";
			detail.info = 2;
