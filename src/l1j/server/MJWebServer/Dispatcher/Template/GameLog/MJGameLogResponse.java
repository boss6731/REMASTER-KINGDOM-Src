...
public class MJGameLogResponse extends MJHttpResponse {
	...
	public HttpResponse get_response() throws l1j.server.MJWebServer.Dispatcher.MJHttpClosedException {
		...
		sb.append("</script>");
		sb.append("<title>plaync ¸®´ÏÁö :: </title>");
		sb.append("</head>");
...
//				sb.append("<li><img src='" + img_url + "' style='width:15px;height:15px;' /></li>");
				sb.append("<li><style=\"width:15px;height:15px;height:15px; !important;\"><font size=2px color=#A4A4A4 face=\"¸¼Àº°íµñ\">"
						+ " <font color=#FF0040 face=\"¸¼Àº°íµñ\">["+ id + ":<font color=#FAFAFA face=\"¸¼Àº°íµñ\">" + img_url + "<font color=#FF0040 face=\"¸¼Àº°íµñ\">]</li>");
