...
public class AppCashChargeInfo {
	...
	public static AppCashChargeInfo chshInfoPaser(Map<String, List<String>> collection, MJUser user) {
		AppCashChargeInfo appCash = new AppCashChargeInfo();
