...
public class MJCashMyChargeListResponse extends MJHttpResponse {
	...
	private void getMyChargeList(StringBuilder stringBuilder, int firstNum) {
		...
		try {
			...
			stringBuilder.append("<center><span class=\"title\"><font color=#A4A4A4>[" + (_player == null ? "null" : _player.getName()) + "님의 충전신청내역] </center></font></span>");
			...
			while (rs.next()) {
				...
				stringBuilder.append("<span class=\"line1\" style=\"width:5% !important;\"><font color=#FF0000>[" + (rs.getInt("is_deposit") == 0 ? "대기" : rs.getInt("is_deposit") == 2 ? "취소" : "완료") + "]</font></span>\n");
