	...
	public HttpResponse get_response() throws l1j.server.MJWebServer.Dispatcher.MJHttpClosedException {
		...
		if (fList != null) {
			...
			for (int i = 0; i < size; i++) {
				...
				sb.append("<div class=\"sell\"><em>최저판매</em><span>");
				sb.append("<strong class=\"low\">");
				sb.append("-");
				sb.append("</strong>");
				sb.append("</span>");
				sb.append("</div>");
				sb.append("<div class=\"buy\"><em>최고구매</em> <span>");
...
//		sb.append(Config.Login.GameServerName);
		...
		sb.append("<p><center>시세 검색 하는 방법</center><p><center>최상단에 검색하시려는 아이템명을 입력 하세요.</center></p></p>");
//		sb.append("<p><center>시세 검색을 통하여 보다 편리하게</center><p><center>판매하는 아이템의 시세를 확인하세요.</center></p></p>");
		sb.append("</div>");
		sb.append("</div>");
		sb.append("</div>");
