...
public class MJHttpFileResponse extends l1j.server.MJWebServer.Dispatcher.Template.MJHttpResponse {
	...
	public HttpResponse get_response() throws l1j.server.MJWebServer.Dispatcher.MJHttpClosedException {
		...
		if(buff == null){
			append_log(String.format("load failure file. %s", filename));
			return create_empty(HttpResponseStatus.NOT_FOUND);
		}
