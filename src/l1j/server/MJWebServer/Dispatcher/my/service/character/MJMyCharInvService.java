...
public class MJMyCharInvService {
	...
	public List<l1j.server.MJWebServer.Dispatcher.my.service.character.MJMyCharInvItemInfo> equippedItems(int characterId){
	...
	public List<l1j.server.MJWebServer.Dispatcher.my.service.character.MJMyCharInvItemInfo> allInventoryItems(int characterId){
		L1PcInstance pc = findMemory(characterId);
		if(pc != null){
	...
	public List<l1j.server.MJWebServer.Dispatcher.my.service.character.MJMyCharInvItemInfo> accountWarehouseItems(String account){
	...
	public List<l1j.server.MJWebServer.Dispatcher.my.service.character.MJMyCharInvItemInfo> characterWarehouseItems(String account){
		L1PcInstance pc = findMemoryFromAccount(account);
		if(pc != null){
	...
	public List<l1j.server.MJWebServer.Dispatcher.my.service.character.MJMyCharInvItemInfo> elfWarehouseItems(String account){
		L1PcInstance pc = findMemoryFromAccount(account);
		if(pc != null){
