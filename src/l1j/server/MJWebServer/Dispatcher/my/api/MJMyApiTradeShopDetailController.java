...
class MJMyApiTradeShopDetailController extends MJMyApiController {
	...
	MJMyApiTradeShopDetailController(MJHttpRequest request) {
		super(request);
	...
	protected MJMyModel responseModel() {
		...
		MJMyShopDetailResult<MJMyTradeShopDetailModel> result = MJMyShopService.service().tradeShopProvider().selectDetail(args, page);		
		MJMyApiTradeShopDetailModel model = new MJMyApiTradeShopDetailModel();
