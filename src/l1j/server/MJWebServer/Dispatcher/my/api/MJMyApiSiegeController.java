...
import l1j.server.MJWebServer.Dispatcher.my.api.MJMyApiSiegeModel.SiegeInfo;
import l1j.server.MJWebServer.Service.MJHttpRequest;
import l1j.server.server.model.L1Clan;

class MJMyApiSiegeController extends MJMyApiController{
	private static final int[] viewCastleIds = new int[]{
		4, 1, 2	
	};
	
	MJMyApiSiegeController(MJHttpRequest request) {
		super(request);
	}
	...
	protected MJMyModel responseModel() {
		MJMyApiSiegeModel model = new MJMyApiSiegeModel();
