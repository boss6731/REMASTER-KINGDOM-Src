...
class MJMyPagePrivateShopDetailController extends MJMyPageController{
	...
	MJMyPagePrivateShopDetailController(MJHttpRequest request, MJMyPageInfo pInfo) {
		super(request, pInfo);
	...
	protected MJMyModel viewModelInternal() {
		...
		model.statistics = MJMyShopService.service().privateShopProvider().selectStatisticsModel(args);
