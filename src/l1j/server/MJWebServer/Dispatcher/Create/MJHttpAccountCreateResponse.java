...
public class MJHttpAccountCreateResponse extends MJHttpResponse {
	...
	public HttpResponse get_response() throws l1j.server.MJWebServer.Dispatcher.MJHttpClosedException {
		...
		if (MJString.isNullOrEmpty(request_mac)) {
			System.out.println(String.format("%s:%d ����ڰ� ������ �������� �õ��� �߽��ϴ�.", address, port));
			HttpResponse response = create_response(HttpResponseStatus.OK, "������������������");
		...
		if (MJString.isNullOrEmpty(accountName) || MJString.isNullOrEmpty(password) || MJString.isNullOrEmpty(hdd_id)) {
			...
			if (!hmac.equalsIgnoreCase(request_mac)) {
				System.out.println(String.format("%s:%d ����� �α��� ���� invalid mac value\r\nrequest : %s,\r\nmake mac : %s",
				...
				if (Config.Login.UseExConnect) {
					...
					if (reason != MJHddIdChecker.DENIALS_TYPE_NONE
						...
						System.out.println(String.format("�ϵ�� ���� Ŭ���̾�Ʈ ���� ���� : %s, %s, %d", accountName, hdd_id, reason));
					...
					if (accountHddCount >= MJNetServerLoadManager.DESKTOP_ADDRESS2ACCOUNT) {
						...
						System.out.println(String.format("��[�ϵ�] �������� �ʰ� : Account : %s, Hdd : %s, Ip : %s �ִ�: %d��", accountName, hdd_id, address, MJNetServerLoadManager.DESKTOP_ADDRESS2ACCOUNT));
				...
				synchronized (_lock) {
					...
					if (account == null) {
						...
						result.result_code = MJEHttpCreateValidation.FAIL_DUPLICATE_ACCOUNT.get_message(); // ����.. �ڵ�
				 ...
				 * MJEHttpCreateValidation.SUCCESS.get_message(); // ���� }else {
				 * result.result_code =
				 * MJEHttpCreateValidation.FAIL_DUPLICATE_ACCOUNT.get_message(); // ����.. �ڵ� �ʿ��ϸ�
				 * ������ �ڵ� �߰� }
				 */
			}
		}
