...
public class MJHddIdChecker {
	...
	public static final int DENIALS_TYPE_INVALID_HDD_ID = 0;           // 不明的硬碟序號
	public static final int DENIALS_TYPE_POWER_KICK = 1;               // 因永久驅逐而被封鎖
	public static final int DENIALS_TYPE_POWER_KICK_DUPLICATE = 2;     // 因永久驅逐而重複連接的客戶端被封鎖
	...
	public static String update_denials(final Account.Account account, final int reason) {
	...
	public static int numOfHddCount(String hddId){
		...
		wrapper.value = 0;
		Selector.exec("select count(hdd_id) as numOfHddCount from netsafe_account_to_drive where hdd_id=?", new SelectorHandler() {
