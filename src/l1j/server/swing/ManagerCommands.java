...
public class ManagerCommands extends JFrame {
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(
				...
				.addComponent(_layer, GroupLayout.DEFAULT_SIZE, 200, GroupLayout.DEFAULT_SIZE))
		);
		layout.setVerticalGroup(
				layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
				.addComponent(_layer, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE))
		);
		pack();
	...
	private void onCommand(ActionEvent evt){
		...
		if(s == null || s.equalsIgnoreCase("")){
			l1j.server.swing.MJMessageBox.show(this, "命令未被選擇。", true);
			return;
		}
		try{
	...
	private void onCancel(ActionEvent evt){
		setVisible(false);
		dispose();
		l1j.server.swing.chocco chocco = null;
