 ...
 public class DominanceDataLoader
 {
   ...
   public Map<Integer, DominanceBoss> _list = new HashMap<>();

   private static List<DominanceBoss> list;
   ...
   public static List<DominanceBoss> getList() {
     synchronized (list) {
   ...
   public static DominanceBoss find(int bossnum) {
     synchronized (list) {
