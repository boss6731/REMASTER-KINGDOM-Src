...
public class AurakiaInDungeonSpawn {
	...
	public <FastTable> FastTable<L1NpcInstance> fillSpawnTable(int mapid, int type) {
		Connection con = null;
	...
	public <FastTable> FastTable<L1NpcInstance> fillSpawnTable(int mapid, int attr, int type, L1NpcInstance npc, boolean countB) {
		Connection con = null;
		PreparedStatement pstm = null;
		ResultSet rs = null;
		L1Npc l1npc = null;
