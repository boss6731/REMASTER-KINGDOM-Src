...
public class MJCaptcha {
	...
	private static final ServerBasePacket[][] _messages = new ServerBasePacket[][]{
			{
					new S_SystemMessage("自動防止碼認證成功。"),
					new S_PacketBox(S_PacketBox.GREEN_MESSAGE, "自動防止碼認證成功。"),
			},
			{
					new S_SystemMessage("自動防止碼認證失敗。"),
					new S_PacketBox(S_PacketBox.GREEN_MESSAGE, "自動防止碼認證失敗。"),
			},
	};
