...
public class CraftListOutputEventItemsInfo {
	static CraftListOutputEventItemsInfo newInstance(ResultSet rs) throws SQLException {
		CraftListOutputEventItemsInfo pInfo = newInstance();
		...
		pInfo._event_id = rs.getInt("event_id");
	...
	private static CraftListOutputEventItemsInfo newInstance() {
		return new CraftListOutputEventItemsInfo();
	}
	...
	private CraftListOutputEventItemsInfo() {
	}
