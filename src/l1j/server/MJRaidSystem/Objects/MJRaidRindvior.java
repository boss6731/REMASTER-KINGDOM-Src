...
public class MJRaidRindvior extends MJRaidObject{
	private static final ServerBasePacket[] s_startMessages = new ServerBasePacket[]{
		new S_ServerMessage(1755),
		new S_ServerMessage(1756),
		new S_ServerMessage(1757),
		new S_ServerMessage(1758),
		new S_SystemMessage("시스템 메시지 : 린드비오르를 공략할 수 있습니다."),
	};
	
	public MJRaidRindvior(L1PcInstance owner, MJRaidType type){
		super(owner, type);
	}
