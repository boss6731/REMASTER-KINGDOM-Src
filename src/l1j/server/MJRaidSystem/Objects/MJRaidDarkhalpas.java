...
public class MJRaidDarkhalpas extends MJRaidObject {
	private static final ServerBasePacket[] s_startMessages = new ServerBasePacket[] {
			new S_PacketBox(S_PacketBox.GREEN_MESSAGE, "$31995"),
			/*new S_PacketBox(S_PacketBox.GREEN_MESSAGE, "$25549"),*/ };

	private static final ServerBasePacket[] s_startMessagesValakas = new ServerBasePacket[] {
			new S_PacketBox(S_PacketBox.GREEN_MESSAGE, "\\fA$31995"),
			/*new S_PacketBox(S_PacketBox.GREEN_MESSAGE, "\\fA$25534"),
			new S_PacketBox(S_PacketBox.GREEN_MESSAGE, "\\fA$25535"),*/ };
...
//	private static final ServerBasePacket s_blackDisplay = new S_DisplayEffect(S_DisplayEffect.BLACK_DISPLAY);
	...
	public MJRaidDarkhalpas(L1PcInstance owner, MJRaidType type) {
		super(owner, type);
	}
	...
	private MJRaidNpcSpawn createSpawn(int npcId, int type, int numOfSpawn, int range, int heading) {
		return new MJRaidNpcSpawn(npcId, type, numOfSpawn, _bossSpawn.getLeft() - range, _bossSpawn.getTop() - range,
				_bossSpawn.getLeft() + range, _bossSpawn.getTop() + range, 0);
	}
...
//	private ArrayList<L1NpcInstance> _fires;
	...
	protected L1NpcInstance halpas_1st = null;
...
//							Thread.sleep(500);
			...
			if (halpas_1st == null) {
				halpas_1st = spawn(32789, 32895, (short)getCopyMapId(), 0, 73201240, 0);
				_state = RS_START;
	...
	private L1NpcInstance spawn(int x, int y, short MapId, int Heading, int npcId, int actioncode) {
		L1NpcInstance npc = null;
		try {
		...
		try {
			...
			while ((_state & RS_START) > 0) {
				...
				if (cur - startTime >= MJRaidLoadManager.MRS_SP_VALAKAS_PRODUCT_TIME) {
					startTime = cur;
					S_NpcChatPacket s_chat = new S_NpcChatPacket(_boss, "$31999", 0);
				...
				// System.out.println("��ų�׽�Ʈ"+skill+"");
				// System.out.println("�޺��׽�Ʈ"+combo+"");
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void bombHp(L1NpcInstance npc) {
		...
		for (int i = 0; i < size; i++) {
			...
			if (cx <= MJRaidLoadManager.MRS_SP_VALAKAS_ABSORB_RANGE
					&& cy <= MJRaidLoadManager.MRS_SP_VALAKAS_ABSORB_RANGE) {
	...
	class SpawnProductTask extends TimerTask {
		...
		public SpawnProductTask() {
			...
			for (int i = 0; i < size; i++) {
				...
				pc.send_effect(19260, true);
				pc.sendPackets(new S_SkillSound(pc.getId(), 15881));
				L1SkillUse.on_icons(pc, L1SkillId.DRAGON_HALPAS_POWER, 60);
	...
	/*private static final int[][] GROUND_FIRE1 = new int[][] { { 32766, 32896 }, { 32765, 32895 }, { 32763, 32896 },
			{ 32764, 32897 }, { 32769, 32898 }, { 32777, 32896 }, { 32778, 32895 }, { 32779, 32896 }, { 32778, 32893 },
			{ 32778, 32889 }, { 32781, 32890 }, { 32779, 32887 }, { 32778, 32886 }, { 32779, 32884 }, { 32780, 32883 },
			{ 32779, 32885 }, { 32777, 32882 }, { 32776, 32881 }, { 32777, 32880 }, { 32775, 32881 }, { 32774, 32879 },
			{ 32768, 32882 }, { 32767, 32884 }, { 32764, 32884 }, { 32763, 32887 }, { 32763, 32893 }, { 32762, 32894 },
			{ 32789, 32896 }, };

	private static final int[][] GROUND_FIRE2 = new int[][] { { 32770, 32897 }, { 32768, 32897 }, { 32771, 32899 },
			{ 32772, 32898 }, { 32773, 32899 }, { 32774, 32898 }, { 32776, 32897 }, { 32776, 32895 }, { 32779, 32890 },
			{ 32778, 32885 }, { 32778, 32883 }, { 32775, 32882 }, { 32769, 32883 }, { 32769, 32881 }, { 32767, 32881 },
			{ 32776, 32884 }, { 32762, 32886 }, { 32764, 32893 }, { 32763, 32883 }, { 32763, 32882 }, };

	private static final int[][] GROUND_FIRE3 = new int[][] { { 32763, 32897 }, { 32769, 32899 }, { 32776, 32898 },
			{ 32779, 32892 }, { 32779, 32893 }, { 32780, 32888 }, { 32777, 32884 }, { 32779, 32881 }, { 32773, 32882 },
			{ 32772, 32881 }, { 32763, 32889 }, { 32762, 32890 }, { 32763, 32890 }, { 32765, 32881 },
			{ 32778, 32904 }, };

	private static final int[][] GROUND_FIRE4 = new int[][] { { 32766, 32898 }, { 32765, 32898 }, { 32763, 32898 },
			{ 32773, 32898 }, { 32779, 32898 }, { 32771, 32882 }, { 32770, 32881 }, { 32765, 32889 }, { 32764, 32891 },
			{ 32765, 32882 }, { 32770, 32877 }, { 32757, 32885 }, };

	private static final int[][] GROUND_FIRE5 = new int[][] { { 32765, 32884 }, { 32766, 32884 }, { 32767, 32884 },
			{ 32768, 32884 }, { 32769, 32884 }, { 32770, 32884 }, { 32771, 32884 }, { 32772, 32884 }, { 32773, 32884 },
			{ 32774, 32884 }, { 32775, 32884 }, { 32776, 32884 }, { 32777, 32884 }, { 32778, 32885 }, { 32778, 32886 },
			{ 32778, 32887 }, { 32778, 32888 }, { 32778, 32889 }, { 32778, 32890 }, { 32778, 32891 }, { 32778, 32892 },
			{ 32778, 32893 }, { 32778, 32894 }, { 32778, 32895 }, { 32778, 32896 }, { 32778, 32897 }, { 32777, 32897 },
			{ 32776, 32897 }, { 32775, 32897 }, { 32774, 32897 }, { 32773, 32897 }, { 32772, 32897 }, { 32771, 32897 },
			{ 32770, 32897 }, { 32769, 32897 }, { 32768, 32897 }, { 32767, 32897 }, { 32766, 32897 }, { 32765, 32897 },
			{ 32765, 32885 }, { 32765, 32886 }, { 32765, 32887 }, { 32765, 32888 }, { 32765, 32889 }, { 32765, 32890 },
			{ 32765, 32891 }, { 32765, 32892 }, { 32765, 32893 }, { 32765, 32894 }, { 32765, 32895 }, { 32765, 32896 },
			{ 32778, 32884 } };*/
...
//	private static MJRaidNpcSpawn _fireSpawn = null;
	...
	/*private ArrayList<L1NpcInstance> createFires() {
		try {
			...
			return _fireSpawn.spawnRectLine(new int[] { MJRaidLoadManager.MRS_SP_VALAKAS_GROUNDFIRE1_ID, MJRaidLoadManager.MRS_SP_VALAKAS_GROUNDFIRE2_ID, MJRaidLoadManager.MRS_SP_VALAKAS_GROUNDFIRE3_ID, MJRaidLoadManager.MRS_SP_VALAKAS_GROUNDFIRE4_ID },
					getCopyMapId());
		} catch (Exception e) {
			e.printStackTrace();
		}
