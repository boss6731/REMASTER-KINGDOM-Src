...
public class TargetToEffect extends MJRaidBossSkill{

	@Override
	public String toString(){
		return TargetToEffect.class.getName();
	}
	...
	private void processAction(L1NpcInstance own, L1PcInstance pc){
		S_EffectLocation packet = new S_EffectLocation(pc.getX(), pc.getY(), _effectId);
