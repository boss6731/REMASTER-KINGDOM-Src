...
public class DeathHeal extends MJRaidBossSkill{
	@Override
	public String toString(){
		return DeathHeal.class.getName();
	}
	...
	public void processAction(L1NpcInstance own, L1PcInstance pc){
		...
		if(pc.hasSkillEffect(MJRaidLoadManager.MRS_BS_DEATHHEAL_ID)){
			pc.removeSkillEffect(MJRaidLoadManager.MRS_BS_DEATHHEAL_ID);
			pc.sendPackets(S_InventoryIcon.icoReset(MJRaidLoadManager.MRS_BS_DEATHHEAL_ID, MJRaidLoadManager.MRS_BS_DEATHHEAL_TIME / 1000, false));
		}else
			pc.sendPackets(S_InventoryIcon.icoNew(MJRaidLoadManager.MRS_BS_DEATHHEAL_ID, MJRaidLoadManager.MRS_BS_DEATHHEAL_TIME / 1000, false));
		pc.setSkillEffect(MJRaidLoadManager.MRS_BS_DEATHHEAL_ID, MJRaidLoadManager.MRS_BS_DEATHHEAL_TIME);
	}
}
