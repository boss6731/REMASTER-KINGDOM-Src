...
public class ReduceHeal extends MJRaidBossSkill{

	@Override
	public String toString(){
		return ReduceHeal.class.getName();
	}
	...
	public void processAction(L1NpcInstance own, L1PcInstance pc){
		...
		if(pc.hasSkillEffect(MJRaidLoadManager.MRS_BS_REDUCEHEAL_ID))
			pc.removeSkillEffect(MJRaidLoadManager.MRS_BS_REDUCEHEAL_ID);
		pc.setSkillEffect(MJRaidLoadManager.MRS_BS_REDUCEHEAL_ID, MJRaidLoadManager.MRS_BS_REDUCEHEAL_TIME);
	}
