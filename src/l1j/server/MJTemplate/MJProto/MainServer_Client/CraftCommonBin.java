...
public class CraftCommonBin implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
			...
			GeneralThreadPool.getInstance().schedule(new Runnable() {
				...
				public void run() {
					...
					if (!message.isInitialized())
						throw new IllegalArgumentException(String.format("fail initialized craftinfo data.(CraftCommonBin) %d", message.getInitializeBit()));
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException {
		while (!input.isAtEnd()) {
			...
			case 0x00000012: {
				add_craft((SC_CRAFT_LIST_ALL_ACK) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.newInstance()));
				break;
			}
			default: {
				return this;
	...
	public static class SC_CRAFT_LIST_ALL_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
		...
		private static HashMap<Integer, ProtoOutputStream> createNpcInfo() {
			...
			try {
				...
				while (rs.next()) {
					...
					Integer[] ids = (Integer[]) MJArrangeParser.parsing(rs.getString("craft_list").trim(), ",", parsee).result();
					for (Integer i : ids) {
		...
		public static void send(L1PcInstance pc, byte[] hash_val) {
			...
			if (MJHexHelper.compareArrays(Config.CraftAlchemySetting.CRAFT_VERSION_HASH, hash_val, Config.CraftAlchemySetting.CRAFT_VERSION_HASH.length)) {
				pc.sendPackets(_craftSameCache, false);
			} else if (Config.CraftAlchemySetting.CRAFTTRANSMITSAFELINE <= L1World.getInstance().getAllPlayersSize()) { //���� ���������� ���س��� ���������� ���ų� Ŭ���� �������� �ʴ´�..
				pc.sendPackets("���� Ŭ���̾�Ʈ�� ���� ������ ���� ���������� ��� ����� ������ ���� �� �ֽ��ϴ�.");
				pc.sendPackets("���ӱ⿡�� ������ġ�� �Ͻ� �� �ٽ� �����ϸ� ��� ����� �޾ƺ� �� �ֽ��ϴ�.");
//				 pc.sendPackets(_craftSameCache);
				pc.sendPackets(_craftSameCache, false);
			} else {
//				 pc.sendPackets("���������� ���ŵ˴ϴ�. 3���� â�� �ߴ� ��� ��ٷ� �ֽʽÿ�. (�����̾����ôٸ� ������ �������Ͻñ� �ٶ��ϴ�)");
				pc.getNetConnection().directSendPacket(_craftCaches);
				/*
				 * GeneralThreadPool.getInstance().execute(new Runnable(){
				 * 
				 * @Override public void run(){ try { pc.getNetConnection().directSendPacket(_craftCaches, Config.CharSettingsInfo.CRAFTDIRECTSENDDELAYMILLIS); } catch (InterruptedException e) { e.printStackTrace(); } } });
				 */
			}
		}
		...
		public l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream writeTo(l1j.server.MJTemplate.MJProto.MJEProtoMessages message) {
			l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream stream = l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.newInstance(getSerializedSize() + l1j.server.MJTemplate.MJProto.WireFormat.WRITE_EXTENDED_SIZE, message.toInt());
			try {
				writeTo(stream);
		...
		public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException {
			while (!input.isAtEnd()) {
				...
				case 0x00000012: {
					add_craft((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.newInstance()));
					break;
				}
				default: {
					return this;
...
//				System.out.println("???????:"+ noti.get_batch_delay_sec());
			...
			public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException {
				while (!input.isAtEnd()) {
					...
					case 0x00000012: {
						set_craft_attr((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftAttr) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftAttr.newInstance()));
						break;
					}
					case 0x00000018: {
					...
					case 0x00000022: {
						set_required_quests((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredQuestList) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredQuestList.newInstance()));
						break;
					}
					case 0x0000002A: {
						set_required_sprites((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredSpriteList) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredSpriteList.newInstance()));
						break;
					}
					case 0x00000032: {
						set_required_items((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredItemList) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredItemList.newInstance()));
						break;
					}
					case 0x0000003A: {
						set_inputs((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftInputList) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftInputList.newInstance()));
						break;
					}
					case 0x00000042: {
						set_outputs((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.newInstance()));
						break;
					}
					case 0x00000048: {
					...
					case 0x00000052: {
						set_period_list((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.PeriodList) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.PeriodList.newInstance()));
						break;
					}
					case 0x00000058: {
			...
			public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.server.GameClient clnt, byte[] bytes) {
				...
				try {
					...
					// TODO : �Ʒ����� ó�� �ڵ带 �����Ͻʽÿ�. made by MJSoft.
			...
			public static class CraftRequiredQuestList implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
				...
				public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException {
					while (!input.isAtEnd()) {
						...
						case 0x0000001A: {
							set_flag((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredQuestList.CraftQuestFlag) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredQuestList.CraftQuestFlag.newInstance()));
							break;
						}
						default: {
							return this;
			...
			public static class CraftRequiredItemList implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
				...
				public void add_items(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredItemList.CraftRequiredItem val) {
					if (!has_items()) {
				...
				public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException {
					while (!input.isAtEnd()) {
						...
						case 0x0000001A: {
							add_items((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredItemList.CraftRequiredItem) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftRequiredItemList.CraftRequiredItem.newInstance()));
							break;
						}
						default: {
							return this;
			...
			public static class CraftInputList implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
				...
				public void add_arr_input_item(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftInputList.CraftInputItem val) {
				...
				public void add_arr_option_item(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftInputList.CraftInputItem val) {
				...
				public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException {
					while (!input.isAtEnd()) {
						...
						switch (tag) {
						case 0x0000000A: {
							add_arr_input_item((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftInputList.CraftInputItem) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftInputList.CraftInputItem.newInstance()));
							break;
						}
						case 0x00000012: {
							add_arr_option_item((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftInputList.CraftInputItem) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftInputList.CraftInputItem.newInstance()));
							break;
						}
						default: {
							return this;
			...
			public static class CraftOutputList implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
				...
				public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException {
					while (!input.isAtEnd()) {
						...
						switch (tag) {
						case 0x0000000A: {
							set_success((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.newInstance()));
							break;
						}
						case 0x00000012: {
							set_failure((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.newInstance()));
							break;
						}
						case 0x00000018: {
...
//					 System.out.println("����Ȯ��: "+real_prob);
...
//					System.out.println("sfList.get_output_items() : " + sfList.get_output_items());
				...
				public static class CraftOutputSFList implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
					...
					public void set_on_flag(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftQuestFlag val) {
						_bit |= 0x1;
						_on_flag = val;
					}
					...
					public void set_off_flag(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftQuestFlag val) {
						_bit |= 0x2;
						_off_flag = val;
					}
					...
					public void add_output_prob_items(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftOutputItem val) {
					...
					public void add_output_items(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftOutputItem val) {
						if (!has_output_items()) {
					...
					public void add_events(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftEvent val) {
						if (!has_events()) {
					...
					public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException {
						while (!input.isAtEnd()) {
							...
							switch (tag) {
							case 0x0000000A: {
								set_on_flag((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftQuestFlag) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftQuestFlag.newInstance()));
								break;
							}
							case 0x00000012: {
								set_off_flag((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftQuestFlag) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftQuestFlag.newInstance()));
								break;
							}
							case 0x00000018: {
							...
							case 0x0000002A: {
								add_output_prob_items((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftOutputItem) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftOutputItem.newInstance()));
								break;
							}
							case 0x00000032: {
								add_output_items((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftOutputItem) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftOutputItem.newInstance()));
								break;
							}
							case 0x0000003A: {
								add_events((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftEvent) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.CraftOutputList.CraftOutputSFList.CraftEvent.newInstance()));
								break;
							}
							case 0x00000040: {
					...
					public static class CraftOutputItem implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
						...
						public int getSerializedSize() {
							...
							if (has_inherit_bless_from()) {
								size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeInt32Size(17, _inherit_bless_from);
							}
							_memorizedSerializedSize = size;
							return size;
						}
						...
						public SC_CRAFT_MAKE_ACK.CraftOutputItem toMakeOutputItemTrans(L1ItemInstance result, int eType, int eValue) {
							SC_CRAFT_MAKE_ACK.CraftOutputItem outputItem = SC_CRAFT_MAKE_ACK.CraftOutputItem.newInstance();
			...
			public static class PeriodList implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
				...
				public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException {
					while (!input.isAtEnd()) {
						...
						switch (tag) {
						case 0x0000000A: {
							add_period((CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.PeriodList.Period) input.readMessage(CraftCommonBin.SC_CRAFT_LIST_ALL_ACK.Craft.PeriodList.Period.newInstance()));
							break;
						}
						default: {
							return this;
		...
		/** RP_CRAFT_LOAD_START:0, RP_CRAFT_LOADING:1, RP_CRAFT_LOAD_FINISH:2, RP_ERROR_SAME_HASH_VAL:3, RP_ERROR_INVALID_HASH_VAL:4, RP_ERROR_UNKNOWN:9999*/
