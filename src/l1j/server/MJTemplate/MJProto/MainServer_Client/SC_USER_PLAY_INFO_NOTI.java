...
//				noti.set_charged_time_map_info(cinfo);
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				case 0x0000000A:{
					add_map_time_limit_info((SC_USER_PLAY_INFO_NOTI.MAP_TIME_LIMIT_INFO)input.readMessage(SC_USER_PLAY_INFO_NOTI.MAP_TIME_LIMIT_INFO.newInstance()));
					break;
				}
				case 0x00000012:{
					set_charged_time_map_info((SC_USER_PLAY_INFO_NOTI.CHARGED_TIME_MAP_INFO)input.readMessage(SC_USER_PLAY_INFO_NOTI.CHARGED_TIME_MAP_INFO.newInstance()));
					break;
				}
				case 0x0000001A:{
					add_charged_time_map_info_group((SC_USER_PLAY_INFO_NOTI.CHARGED_TIME_MAP_INFO)input.readMessage(SC_USER_PLAY_INFO_NOTI.CHARGED_TIME_MAP_INFO.newInstance()));
					break;
				}
				default:{
					return this;
