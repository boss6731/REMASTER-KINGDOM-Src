	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				...
				case 0x00000032:{
					add_attendanceBonuses((SC_ATTENDANCE_BONUS_INFO.AttendanceBonus)input.readMessage(SC_ATTENDANCE_BONUS_INFO.AttendanceBonus.newInstance()));
					break;
				}
				default:{
					return this;
		...
		public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
			while(!input.isAtEnd()){
				...
				switch(tag){
					...
					case 0x00000012:{
						add_bonuses((SC_ATTENDANCE_BONUS_INFO.BonusInfo)input.readMessage(SC_ATTENDANCE_BONUS_INFO.BonusInfo.newInstance()));
						break;
					}
					default:{
						return this;
