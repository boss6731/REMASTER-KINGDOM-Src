...
public class SC_REVENGE_DELETE_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_REVENGE_DELETE_ACK newInstance() {
		return new SC_REVENGE_DELETE_ACK();
	}

	public static void send(L1PcInstance pc) {
		SC_REVENGE_DELETE_ACK noti = newInstance();
		noti.set_result(eRevengeResult.SUCCESS);
		pc.sendPackets(noti, MJEProtoMessages.SC_REVENGE_DELETE_ACK);
	}
