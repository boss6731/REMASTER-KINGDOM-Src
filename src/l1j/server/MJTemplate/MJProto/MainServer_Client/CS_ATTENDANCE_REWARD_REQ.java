...
public class CS_ATTENDANCE_REWARD_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	public MJIProtoMessage readFrom(l1j.server.server.GameClient clnt, byte[] bytes){
		...
		try{
			...
			if(egroup == null){
				System.out.println(String.format("[��ý]�� �� ���� ��ý �׷�! �ɸ��� : %s", pc.getName()));
				return this;
			}
			...
			if(timeStatus.equals(UserAttendanceTimeStatus.ATTENDANCE_ALL_CLEAR)){
				System.out.println(String.format("[��ý]��� ������ ���� ������ ������ �õ�! �ɸ��� : %s, �׷� : %s", pc.getName(), egroup.name()));
				pc.sendPackets("�̹� ��� ������ �����̽��ϴ�.");
				return this;
			}
			...
			if(!attendance_data.get_state().equals(UserAttendanceState.COMPLETE)){
				System.out.println(String.format("[��ý]���¿� ���� �ʴ� ������ �䱸! �ɸ��� : %s, �׷� : %s, �ε��� : %d, ���� : %s", pc.getName(), egroup.name(), attendance_data.get_index(), attendance_data.get_state().name()));
				pc.sendPackets("������ ���� �� �����ϴ�.");
				return this;
			}
			final AttendanceBonusInfo bInfo = egroup.select_reward(_attendance_id - 1);
			if(bInfo == null){
				System.out.println(String.format("[��ý]���� �������� ã�� �� ����! �ɸ��� : %s, �׷� : %s, �ε��� : %d, ���� : %s", pc.getName(), egroup.name(), attendance_data.get_index(), attendance_data.get_state().name()));
				pc.sendPackets("������ ���� �� �����ϴ�.");
				return this;
			}
			int seasonnum = 0;
			...
			if (get_group_id() == 2) {
				...
				if (!account.getAttendance_Premium()) {
					pc.sendPackets("�����̾� �⼮üũ�� Ȱ��ȭ �Ͻ� �� �̿� �����մϴ�.");
					return this;
				}
			}
			if (get_group_id() == 3) {
