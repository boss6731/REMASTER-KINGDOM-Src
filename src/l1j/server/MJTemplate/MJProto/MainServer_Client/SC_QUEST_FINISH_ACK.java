...
public class SC_QUEST_FINISH_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_QUEST_FINISH_ACK newInstance() {
		return new SC_QUEST_FINISH_ACK();
	}
	...
	public enum eResultCode {
		...
		public static eResultCode fromInt(int i) {
			switch (i) {
				...
				case 3:
					return FAIL_NOT_COMPLETED;
				case 4:
					return FAIL_NOT_VALID_REWARD_INDEXES;
				case 5:
					return FAIL_OBSOLETE;
				default:
					return null;
			}
		}
