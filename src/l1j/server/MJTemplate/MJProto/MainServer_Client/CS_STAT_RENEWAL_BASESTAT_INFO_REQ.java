...
public class CS_STAT_RENEWAL_BASESTAT_INFO_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_STAT_RENEWAL_BASESTAT_INFO_REQ newInstance() {
		return new CS_STAT_RENEWAL_BASESTAT_INFO_REQ();
	}
	...
	private CS_STAT_RENEWAL_BASESTAT_INFO_REQ() {
	}
