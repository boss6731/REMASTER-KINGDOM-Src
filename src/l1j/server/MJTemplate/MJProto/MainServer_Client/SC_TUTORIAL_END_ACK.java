...
public class SC_TUTORIAL_END_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_TUTORIAL_END_ACK newInstance() {
		return new SC_TUTORIAL_END_ACK();
	}
