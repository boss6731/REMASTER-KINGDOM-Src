...
public class SC_ALCHEMY_DESIGN_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	public static void send(L1PcInstance pc, byte[] hash_val){
		try{
			...
			if(MJHexHelper.compareArrays(Config.CraftAlchemySetting.ALCHEMY_VERSION_HASH, hash_val, Config.CraftAlchemySetting.ALCHEMY_VERSION_HASH.length)){
...
//				pc.sendPackets("���������� ���ŵ˴ϴ�. 1���� â�� �ߴ� ��� ��ٷ� �ֽʽÿ�.");
				GeneralThreadPool.getInstance().schedule(new Runnable(){
					@Override
					public void run(){
