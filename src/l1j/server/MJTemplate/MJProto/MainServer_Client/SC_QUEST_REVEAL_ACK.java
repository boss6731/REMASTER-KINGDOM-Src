...
public class SC_QUEST_REVEAL_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_QUEST_REVEAL_ACK newInstance() {
		return new SC_QUEST_REVEAL_ACK();
	}
		...
		public static eResultCode fromInt(int i) {
			switch (i) {
				...
				case 1:
					return FAIL;
				case 2:
					return FAIL_ALREADY_REVEALED;
				case 3:
					return FAIL_ALREADY_STARTED;
				case 4:
