...
public class SC_CRITERIA_UPDATE_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_CRITERIA_UPDATE_NOTI newInstance(CriteriaProgress progress) {
		SC_CRITERIA_UPDATE_NOTI noti = newInstance();
		noti.set_criteria_id(progress.get_criteria_id());
		noti.set_quantity(progress.get_quantity());
		return noti;
	}

	public static SC_CRITERIA_UPDATE_NOTI newInstance() {
		return new SC_CRITERIA_UPDATE_NOTI();
	}
	...
	private SC_CRITERIA_UPDATE_NOTI() {
	}
