...
public class SC_CONNECT_HIBREEDSERVER_NOTI_PACKET implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	...
	public static SC_CONNECT_HIBREEDSERVER_NOTI_PACKET newInstanceNoti(GameClient clnt, String accountName, String accountPassword, int characterId, String characterName, int x, int y, int mapid,
...
//			noti.set_destPort(2000);
			...
			noti.set_onetimetoken(new StringBuilder().append(accountName).append("|").append(characterName).append("|").append(characterId).append("|").append(x).append("|").append(y).append("|")
					.append(mapid).append("|").append(backX).append("|").append(backY).append("|").append(backMapId).append("|").append(back_reserved_no).toString().getBytes());
	...
	public static void do_send(L1PcInstance pc, int x, int y, int mapid, int reserved_no) {
		...
		SC_CONNECT_HIBREEDSERVER_NOTI_PACKET noti = newInstanceNoti(pc.getNetConnection(), pc.getAccountName(), pc.getAccount().get_Password(), pc.getId(), pc.getName(), x, y, mapid, pc.getX(),
...
//		noti.set_destPort(2000);
		...
		noti.set_onetimetoken(new StringBuilder().append(pc.getAccountName()).append("|").append(pc.getName()).append("|").append(pc.getId()).append("|").append(x).append("|").append(y).append("|")
				.append(mapid).append(x).append("|").append(y).append("|").append(mapid).append("|").append(RESERVED_INTER_BACK).toString().getBytes());
