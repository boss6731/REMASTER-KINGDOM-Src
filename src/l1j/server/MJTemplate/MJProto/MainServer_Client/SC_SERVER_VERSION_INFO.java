...
//			_version.set_build_number(Integer.toUnsignedString(MJNetSafeLoadManager.NS_CLIENT_VERSION));
	...
	public void do_print() {
		System.out.println(String.format("[����üũ]\t%d(%08X)", _version_check, _version_check));
		System.out.println(String.format("[�������̵�]\t%d(%08X)", _server_id, _server_id));
		System.out.println(String.format("[���� ��ȣ]\t%s(%08X)", Integer.toUnsignedString(_build_number), _build_number));
		System.out.println(String.format("[ĳ�� ����]\t%s(%08X)", Integer.toUnsignedString(_cache_version), _cache_version));
		System.out.println(String.format("[���� ����]\t%d(%08X)", _auth_version, _auth_version));
		System.out.println(String.format("[���Ǿ�����]\t%s(%08X)", Integer.toUnsignedString(_npc_server_version), _npc_server_version));
		System.out.println(String.format("[�����ǿ����]\t%d(%08X)", _english_only_config, _english_only_config));
		System.out.println(String.format("[�����ڵ�]\t%d(%08X)", _country_code, _country_code));
		System.out.println(String.format("[Ŭ���̾�Ʈ����ġ]\t%d(%08X)", _client_setting_switch, _client_setting_switch));
		System.out.println(String.format("[���ӽð�]\t%d(%08X)", _game_real_time, _game_real_time));
		System.out.println(String.format("[�۷ι�ĳ�ù���]\t%d(%08X)", _global_cache_version, _global_cache_version));
		System.out.println(String.format("[Ž��������]\t%d(%08X)", _tam_server_version, _tam_server_version));
		System.out.println(String.format("[�Ƹ�ī��������]\t%d(%08X)", _arca_server_version, _arca_server_version));
		System.out.println(String.format("[���ͼ�������]\t%d(%08X)", _hibreed_inter_server_version, _hibreed_inter_server_version));
		System.out.println(String.format("[�Ʒ����ڼ�������]\t%d(%08X)", _arenaco_server_version, _arenaco_server_version));
		System.out.println(String.format("[����Ÿ��]\t%d(%08X)", _server_type, _server_type));
	}
...
//			size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeUInt64Size(3, _build_number);
		}
		...
		if (has_hibreed_inter_server_version()){
			size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeUInt32Size(15, _hibreed_inter_server_version);
		}
