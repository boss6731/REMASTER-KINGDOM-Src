...
public class AttendanceBonusRandomGroup implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				case 0x0000000A:{
					add_refreshCost((AttendanceBonusRandomGroup.RandomRefreshCost)input.readMessage(AttendanceBonusRandomGroup.RandomRefreshCost.newInstance()));
					break;
				}
				case 0x00000012:{
					add_bonusInfo((AttendanceBonusRandomGroup.RandomBonusInfo)input.readMessage(AttendanceBonusRandomGroup.RandomBonusInfo.newInstance()));
					break;
				}
				case 0x0000001A:{
					set_openCost((AttendanceBonusRandomGroup.OpenTabCost)input.readMessage(AttendanceBonusRandomGroup.OpenTabCost.newInstance()));
					break;
				}
				default:{
					return this;
