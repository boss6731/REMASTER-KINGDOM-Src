...
public class CS_ATTENDANCE_BONUS_REQUEST implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_ATTENDANCE_BONUS_REQUEST newInstance() {
		return new CS_ATTENDANCE_BONUS_REQUEST();
	}
	...
	private CS_ATTENDANCE_BONUS_REQUEST() {
	}
