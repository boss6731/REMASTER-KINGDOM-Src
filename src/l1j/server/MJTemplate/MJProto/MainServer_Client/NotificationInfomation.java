...
//		}
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				...
				case 0x0000003A:{
					set_teleport((NotificationInfomation.TeleportData)input.readMessage(NotificationInfomation.TeleportData.newInstance()));
					break;
				}
				case 0x00000042:{
					set_eventnpc((NotificationInfomation.EventNpcData)input.readMessage(NotificationInfomation.EventNpcData.newInstance()));
					break;
				}
				case 0x00000048:{
	...
	public static class EventNpcInfo implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
		...
		public int getSerializedSize(){
			...
			if (has_rest_gauge_bonus_display()){
				size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeUInt32Size(4, _rest_gauge_bonus_display);
			}
			_memorizedSerializedSize = size;
			return size;
		}
	...
	public static class EventNpcData implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
		...
		public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
			while(!input.isAtEnd()){
				...
				switch(tag){
					case 0x0000000A:{
						add_eventinfo((NotificationInfomation.EventNpcInfo)input.readMessage(NotificationInfomation.EventNpcInfo.newInstance()));
						break;
					}
					default:{
						return this;
