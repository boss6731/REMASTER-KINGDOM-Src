...
public class SC_QUEST_SHOW_IN_WINDOW_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_QUEST_SHOW_IN_WINDOW_ACK newInstance() {
		return new SC_QUEST_SHOW_IN_WINDOW_ACK();
	}
	...
	private SC_QUEST_SHOW_IN_WINDOW_ACK() {
	}
	...
	public int getSerializedSize() {
		...
		if (has_is_show())
			size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeBoolSize(3, _is_show);
