...
public class CS_QUEST_TELEPORT_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_QUEST_TELEPORT_REQ newInstance() {
		return new CS_QUEST_TELEPORT_REQ();
	}
	...
	public MJIProtoMessage readFrom(l1j.server.server.GameClient clnt, byte[] bytes) {
		...
		try {
			...
			MJBeginnerControllerProvider.provider().clientController().onTeleport(pc, get_id());
		} catch (Exception e) {
			e.printStackTrace();
		}
		return this;
