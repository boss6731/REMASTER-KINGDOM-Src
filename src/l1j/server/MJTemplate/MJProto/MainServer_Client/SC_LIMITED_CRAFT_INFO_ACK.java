...
public class SC_LIMITED_CRAFT_INFO_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	...
	public static void send(L1PcInstance pc, int craft_id) {
		...
		/*
		 * if (craft_id == 3870) {//이렇게 하면 결과템 커스텀가능.. pc.sendPackets("해당 제작은 서비스가 일시적으로 중단되었습니다."); result = eCraftIdInfoReqResultType.RP_ERROR_CRAFT_ID; return; }
		 */
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException {
		while (!input.isAtEnd()) {
			...
			case 0x00000012: {
				set_craft_id_info((SC_LIMITED_CRAFT_INFO_ACK.CraftIdInfo) input.readMessage(SC_LIMITED_CRAFT_INFO_ACK.CraftIdInfo.newInstance()));
				break;
			}
			default: {
				return this;
...
// }
//
// public static void test(L1PcInstance pc, int craft_id, int cur_success_cnt, int max_success_cnt){
...
//
// private SC_LIMITED_CRAFT_INFO_ACK.eCraftIdInfoReqResultType _eResult;
// private java.util.LinkedList<SC_LIMITED_CRAFT_INFO_ACK.CraftIdInfo> _craft_id_info;
// private int _memorizedSerializedSize = -1;
// private byte _memorizedIsInitialized = -1;
// private int _bit;
// private SC_LIMITED_CRAFT_INFO_ACK(){
...
// return (_bit & 0x1) == 0x1;
// }
// public java.util.LinkedList<SC_LIMITED_CRAFT_INFO_ACK.CraftIdInfo> get_craft_id_info(){
// return _craft_id_info;
// }
// public void add_craft_id_info(SC_LIMITED_CRAFT_INFO_ACK.CraftIdInfo val){
// if(!has_craft_id_info()){
// _craft_id_info = new java.util.LinkedList<SC_LIMITED_CRAFT_INFO_ACK.CraftIdInfo>();
// _bit |= 0x2;
// }
...
// @Override
// public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.server.GameClient clnt, byte[] bytes){
// l1j.server.MJTemplate.MJProto.IO.ProtoInputStream is = l1j.server.MJTemplate.MJProto.IO.ProtoInputStream.newInstance(bytes, l1j.server.MJTemplate.MJProto.WireFormat.READ_EXTENDED_SIZE, ((bytes[3] & 0xff) | (bytes[4] << 8 & 0xff00)) +
