...
public class SC_USER_START_SUNDRY_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static void send(L1PcInstance pc, boolean isPC방버프) {
		SC_USER_START_SUNDRY_NOTI noti = newInstance();
		noti.set_is_pccafe(isPC방버프);
	...
	public static void send2(L1PcInstance pc, boolean isPC방버프) {
		SC_USER_START_SUNDRY_NOTI noti = newInstance();
		noti.set_is_pccafe(isPC방버프);
		noti.set_is_enable_ranking_system(true);
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				...
				case 0x0000002A:{
					set_eventInfo((SC_USER_START_SUNDRY_NOTI.eventHeroServer)input.readMessage(SC_USER_START_SUNDRY_NOTI.eventHeroServer.newInstance()));
					break;
				}
				case 0x00000030:{
