...
public class SC_CHAT_MESSAGE_NOTI_PACKET implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	public static ProtoOutputStream chat_send(L1PcInstance pc, ChatType type, byte[] message, byte[] target_name, int target_server, byte[] link_m) throws UnsupportedEncodingException {
