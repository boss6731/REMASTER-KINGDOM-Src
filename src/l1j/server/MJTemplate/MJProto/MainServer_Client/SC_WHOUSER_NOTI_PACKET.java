...
public class SC_WHOUSER_NOTI_PACKET implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				case 0x0000000A:{
					add_whouserinfo((SC_WHOUSER_NOTI_PACKET.WHOUSER_INFO)input.readMessage(SC_WHOUSER_NOTI_PACKET.WHOUSER_INFO.newInstance()));
					break;
				}
				case 0x00000010:{
				...
				case 0x0000001A:{
					add_hunting_map_info((SC_WHOUSER_NOTI_PACKET.HuntingMapInfo)input.readMessage(SC_WHOUSER_NOTI_PACKET.HuntingMapInfo.newInstance()));
					break;
				}
				default:{
					return this;
		...
		public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
			while(!input.isAtEnd()){
				...
				switch(tag){
					...
					case 0x00000032:{
						set_accountinfo((SC_WHOUSER_NOTI_PACKET.ACCOUNT_INFO)input.readMessage(SC_WHOUSER_NOTI_PACKET.ACCOUNT_INFO.newInstance()));
						break;
					}
					default:{
						return this;
