...
public class CS_TUTORIAL_END_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static CS_TUTORIAL_END_REQ newInstance(){
		return new CS_TUTORIAL_END_REQ();
	}
	private TUTORIAL_TYPE _type;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private CS_TUTORIAL_END_REQ(){
	}
