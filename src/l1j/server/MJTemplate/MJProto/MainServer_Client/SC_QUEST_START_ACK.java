...
public class SC_QUEST_START_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_QUEST_START_ACK newInstance() {
		return new SC_QUEST_START_ACK();
	}
