...
//	if (pc.isFencer()) {
//		noti.set_next_spell_global_delay(IntRange.getTotalValueToPercent(delay, 14, true));
//		//System.out.println("delay:" + delay + " div:" + IntRange.getTotalValueToPercent(delay, 14, true));
