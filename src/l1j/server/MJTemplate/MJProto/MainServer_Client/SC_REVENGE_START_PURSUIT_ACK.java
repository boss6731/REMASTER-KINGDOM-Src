...
public class SC_REVENGE_START_PURSUIT_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_REVENGE_START_PURSUIT_ACK newInstance() {
		return new SC_REVENGE_START_PURSUIT_ACK();
	}
	...
	private SC_REVENGE_START_PURSUIT_ACK() {
	}
	...
	public int getSerializedSize() {
		...
		if (has_target()) {
			size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeMessageSize(2, _target);
		}
