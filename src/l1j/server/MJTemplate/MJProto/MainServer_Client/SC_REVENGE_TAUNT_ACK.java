...
public class SC_REVENGE_TAUNT_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_REVENGE_TAUNT_ACK newInstance() {
		return new SC_REVENGE_TAUNT_ACK();
	}
