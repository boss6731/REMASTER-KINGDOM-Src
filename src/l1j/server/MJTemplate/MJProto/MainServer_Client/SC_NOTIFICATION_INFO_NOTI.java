...
//			System.out.println(npc.getNpcId()+"+"+npc.get_boss_hour()+"+"+npc.get_boss_minute());
			...
			long endtime = npc.get_end_boss_time() / 1000; // �˶�â���� ����� �ð� �д��� 1�̸� 1��
			long start_time = npc.get_boss_time() / 1000; // ���� �ߴ½ð�
...
//				System.out.println(et);
				...
				monster_name = TeamDeathMatchName+" ������ġ 1ȸ";
			} else if (bosstype == 52) {
				monster_name = TeamDeathMatchName+" ������ġ 2ȸ";
			} else if (bosstype == 53) {
				monster_name = TeamDeathMatchName+" ������ġ 3ȸ";
			} else if (bosstype == 54) {
				monster_name = TeamDeathMatchName+" ������ġ 4ȸ";
			}
...
//			System.out.println("�̺�Ʈ ���۽ð�"+start_time);
...
//					System.out.println(subnpcid);
	...
	public MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws IOException {
		while (!input.isAtEnd()) {
			...
			case 0x0000001A: {
				add_notificationinfo((NotificationInfomation) input.readMessage(NotificationInfomation.newInstance()));
				break;
			}
			}
		}
