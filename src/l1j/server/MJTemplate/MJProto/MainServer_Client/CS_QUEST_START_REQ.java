...
public class CS_QUEST_START_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_QUEST_START_REQ newInstance() {
		return new CS_QUEST_START_REQ();
	}
	...
	public MJIProtoMessage readFrom(l1j.server.server.GameClient clnt, byte[] bytes) {
		...
		try {
			...
			MJBeginnerControllerProvider.provider().clientController().onStart(pc, get_id());
		} catch (Exception e) {
			e.printStackTrace();
		}
		return this;
