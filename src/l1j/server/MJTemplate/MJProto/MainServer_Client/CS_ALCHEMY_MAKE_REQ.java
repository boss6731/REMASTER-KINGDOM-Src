...
public class CS_ALCHEMY_MAKE_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	private L1Item toInvalidOutputItem(L1PcInstance pc){
		System.out.println(String.format("[(�����ռ�)Output�� ã�� �� �����ϴ�.] ĳ���� �̸� : %s, �ռ����̵� : %d", pc.getName(), _alchemy_id));
	...
	private CS_ALCHEMY_MAKE_REQ toInvalidAlchemyId(L1PcInstance pc){
		...
		System.out.println(String.format("[(�����ռ�)Alchemy Id�� ã�� �� �����ϴ�.] ĳ���� �̸� : %s, �ռ����̵� : %d", pc.getName(), _alchemy_id));
		return this;
	}
	...
	private CS_ALCHEMY_MAKE_REQ toInvalidInput(L1PcInstance pc){
		...
		System.out.println(String.format("[(�����ռ�)Inputs�� ã�� �� �����ϴ�.] ĳ���� �̸� : %s, �ռ����̵� : %d, ĳ������ǲ������ : %d", pc.getName(), _alchemy_id, _inputs.size()));
		return this;
	}
	
	private CS_ALCHEMY_MAKE_REQ toInvalidInputForInventory(L1PcInstance pc){
		SC_ALCHEMY_MAKE_ACK.ResultCode.RC_ERROR_INVALID_INPUT.sendCachedMessage(pc);
		System.out.println(String.format("[(�����ռ�)������ ������ ���������� �κ��丮���� ã�� �� �����ϴ�.] ĳ���� �̸� : %s, �ռ����̵� : %d", pc.getName(), _alchemy_id));
	...
	private CS_ALCHEMY_MAKE_REQ doNotAllowInventory(L1PcInstance pc, int addCode){
		(addCode == L1Inventory.WEIGHT_OVER ? 
				SC_ALCHEMY_MAKE_ACK.ResultCode.RC_ERROR_WEIGHT_OVER : SC_ALCHEMY_MAKE_ACK.ResultCode.RC_ERROR_INVEN_OVER)
...
//		// original formula.
//		if(_alchemy_id != 5 && _alchemy_id != 6 && _alchemy_id != 7 && !AlchemyProbability.getInstance().is_winning(_alchemy_id, _inputs.size()))
//			return selectRemovedItemTemplate();
//
			...
			public void run(){
				if(resultAlchemyId >= Config.CraftAlchemySetting.ALCHEMYNOTIFYLEVEL && !ResultCode.RC_FAIL.equals(_resultCode)){
					...
					if (resultItemInstance.getBless() == 1) {
						...
						message = String.format("�ູ���� %s", resultItemInstance.getName());
					}
					
					L1World.getInstance().broadcastPacketToAll(SC_MESSAGE_NOTI.newDollMessage(resultItemInstance.getItem().getItemDescId(), message), true);
				}
				try{
					pc.getInventory().storeItem(resultItemInstance, true);
				}catch(Exception e){
					System.out.println(String.format("[(�����ռ�)���� ����� ���� �ɸ��Ͱ� �����ϴ�.] ĳ���� �̸� : %s, �����۾��̵� : %d, ������ �̸� : %s", name, resultItemInstance.getItemId(), resultItemInstance.getName()));
	...
	public MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				...
				case 0x0000001A:{
					set_subinput((CS_ALCHEMY_MAKE_REQ.SubInput)input.readMessage(CS_ALCHEMY_MAKE_REQ.SubInput.newInstance()));
					break;
				}
			}
		}
...
//					list = _alchemy_id -Config.CraftAlchemySetting.alchemynum;
			...
			LoggerInstance.getInstance().addDollMake(pc, result_instance, _resultCode == SC_ALCHEMY_MAKE_ACK.ResultCode.RC_SUCCESS || _resultCode == SC_ALCHEMY_MAKE_ACK.ResultCode.RC_HYPER_SUCCESS);
			doMake(pc, result_instance);
		} catch(Exception e){
			if(pc != null){
				System.out.println(String.format("[(�����ռ�)���� ����.]�ɸ��� �̸� : %s", pc.getName()));
