...
//			add_hp = 200;
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				case 0x0000000A:{
					set_strinfo((SC_STAT_RENEWAL_BASESTAT_INFO_RES.STR_INFO)input.readMessage(SC_STAT_RENEWAL_BASESTAT_INFO_RES.STR_INFO.newInstance()));
					break;
				}
				case 0x00000012:{
					set_intinfo((SC_STAT_RENEWAL_BASESTAT_INFO_RES.INT_INFO)input.readMessage(SC_STAT_RENEWAL_BASESTAT_INFO_RES.INT_INFO.newInstance()));
					break;
				}
				case 0x0000001A:{
					set_wisinfo((SC_STAT_RENEWAL_BASESTAT_INFO_RES.WIS_INFO)input.readMessage(SC_STAT_RENEWAL_BASESTAT_INFO_RES.WIS_INFO.newInstance()));
					break;
				}
				case 0x00000022:{
					set_dexinfo((SC_STAT_RENEWAL_BASESTAT_INFO_RES.DEX_INFO)input.readMessage(SC_STAT_RENEWAL_BASESTAT_INFO_RES.DEX_INFO.newInstance()));
					break;
				}
				case 0x0000002A:{
					set_coninfo((SC_STAT_RENEWAL_BASESTAT_INFO_RES.CON_INFO)input.readMessage(SC_STAT_RENEWAL_BASESTAT_INFO_RES.CON_INFO.newInstance()));
					break;
				}
				case 0x00000032:{
					set_chainfo((SC_STAT_RENEWAL_BASESTAT_INFO_RES.CHA_INFO)input.readMessage(SC_STAT_RENEWAL_BASESTAT_INFO_RES.CHA_INFO.newInstance()));
					break;
				}
				default:{
					return this;
