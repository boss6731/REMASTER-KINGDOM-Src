...
public class SC_NO_DB_RELOAD_UPDATE_CHAR_INFO implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				case 0x0000000A:{
					add_updateDeleteInfo((SC_NO_DB_RELOAD_UPDATE_CHAR_INFO.UpdateDeleteInfo)input.readMessage(SC_NO_DB_RELOAD_UPDATE_CHAR_INFO.UpdateDeleteInfo.newInstance()));
					break;
				}
				default:{
					return this;
