		...
		public static class GradeRewardT implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
			...
			public static class ConditionalRewardT implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
				...
				public int getSerializedSize(){
					...
					if (has_Connective())
						size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeEnumSize(3, _Connective.toInt());
					if (has_Set()){
				...
				public MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws IOException{
					while(!input.isAtEnd()){
						...
						switch(tag){
							...
							case 0x0000000A:{
								add_ConditionalReward((ConditionalRewardT)input.readMessage(ConditionalRewardT.newInstance()));
								break;
							}
							case 0x00000010:{
