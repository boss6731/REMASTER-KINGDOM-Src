...
public class SC_SYNC_REMOVE_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static SC_SYNC_REMOVE_NOTI newInstance(){
		return new SC_SYNC_REMOVE_NOTI();
	}
	private int _target_id;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private SC_SYNC_REMOVE_NOTI(){
	}
