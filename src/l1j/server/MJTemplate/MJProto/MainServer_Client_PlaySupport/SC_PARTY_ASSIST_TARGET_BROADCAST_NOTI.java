...
public class SC_PARTY_ASSIST_TARGET_BROADCAST_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static SC_PARTY_ASSIST_TARGET_BROADCAST_NOTI newInstance(){
		return new SC_PARTY_ASSIST_TARGET_BROADCAST_NOTI();
	}
	private int _target_id;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private SC_PARTY_ASSIST_TARGET_BROADCAST_NOTI(){
	}
