...
public class SC_PSS_TIME_CHECK_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static SC_PSS_TIME_CHECK_ACK newInstance(){
		return new SC_PSS_TIME_CHECK_ACK();
	}
	private int _remain_time;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private SC_PSS_TIME_CHECK_ACK(){
	}
