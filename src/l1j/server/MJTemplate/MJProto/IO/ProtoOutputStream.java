package l1j.server.server.MJTemplate.MJProto.IO;

import l1j.server.MJTemplate.MJProto.MJEProtoMessages;
import l1j.server.MJTemplate.MJProto.WireFormat;
import l1j.server.server.MJTemplate.MJProto.MJIProtoMessage;
...
public class ProtoOutputStream {
	...
	public static ProtoOutputStream newInstance(MJIProtoMessage imessage, MJEProtoMessages messageId) {
		ProtoOutputStream stream = newInstance(imessage.getSerializedSize() + 5, messageId.toInt());
	...
	public void writeMessage(final int fieldNumber, final MJIProtoMessage value) throws IOException{
		writeTag(fieldNumber, WireFormat.WIRETYPE_LENGTH_DELIMITED);
	...
	public void writeMessageNoTag(final MJIProtoMessage value) throws IOException{
		if(value == null){
			writeRawByte(0x00);
			return;
		}
	...
	public static int computeMessageSize(final int fieldNumber, final MJIProtoMessage value){
	...
	public static int computeInt32SizeNoTag(final int value){
		return value >= 0 ? computeRawVarInt64Size(value) : 10;
	}
	...
	public static int computeMessageSizeNoTag(final MJIProtoMessage value){
		if(value == null)
			return 1;
