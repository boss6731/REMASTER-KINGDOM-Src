...
public class WorldInfluencer implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				case 0x0000000A:{
					add_Influencer((WorldInfluencer.InfluencerT)input.readMessage(WorldInfluencer.InfluencerT.newInstance()));
					break;
				}
				default:{
					return this;
		...
		public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
			while(!input.isAtEnd()){
				...
				switch(tag){
					...
					case 0x0000001A:{
						add_Influence((WorldInfluencer.InfluencerT.InfluenceT)input.readMessage(WorldInfluencer.InfluencerT.InfluenceT.newInstance()));
						break;
					}
					case 0x00000022:{
						add_Display((WorldInfluencer.InfluencerT.DisplayT)input.readMessage(WorldInfluencer.InfluencerT.DisplayT.newInstance()));
						break;
					}
					case 0x0000002A:{
						add_Include((WorldInfluencer.InfluencerT.BoundT)input.readMessage(WorldInfluencer.InfluencerT.BoundT.newInstance()));
						break;
					}
					case 0x00000032:{
						add_Exclude((WorldInfluencer.InfluencerT.BoundT)input.readMessage(WorldInfluencer.InfluencerT.BoundT.newInstance()));
						break;
					}
					default:{
						return this;
