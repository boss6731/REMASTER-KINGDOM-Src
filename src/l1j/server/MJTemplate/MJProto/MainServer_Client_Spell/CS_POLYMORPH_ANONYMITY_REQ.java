...
public class CS_POLYMORPH_ANONYMITY_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static CS_POLYMORPH_ANONYMITY_REQ newInstance(){
		return new CS_POLYMORPH_ANONYMITY_REQ();
	}
	private ePolymorphAnonymityType _anonymity_type;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private CS_POLYMORPH_ANONYMITY_REQ(){
	}
