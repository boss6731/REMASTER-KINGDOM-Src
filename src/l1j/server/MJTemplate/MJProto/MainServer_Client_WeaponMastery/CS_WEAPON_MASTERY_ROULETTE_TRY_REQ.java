...
public class CS_WEAPON_MASTERY_ROULETTE_TRY_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static CS_WEAPON_MASTERY_ROULETTE_TRY_REQ newInstance(){
		return new CS_WEAPON_MASTERY_ROULETTE_TRY_REQ();
	}
	private int _weapon_type;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private CS_WEAPON_MASTERY_ROULETTE_TRY_REQ(){
	}
