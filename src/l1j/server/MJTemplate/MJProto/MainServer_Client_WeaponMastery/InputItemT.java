...
public class InputItemT implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static InputItemT newInstance(){
		return new InputItemT();
	}
	...
	public int getSerializedSize(){
		int size = 0;
		if (has_slot_id()){
			size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeInt32Size(1, _slot_id);
		}
		if (has_name_id()){
