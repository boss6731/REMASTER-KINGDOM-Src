...
public class SC_WEAPON_MASTERY_ROULETTE_SLOT_OPEN_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static SC_WEAPON_MASTERY_ROULETTE_SLOT_OPEN_NOTI newInstance(){
		return new SC_WEAPON_MASTERY_ROULETTE_SLOT_OPEN_NOTI();
	}
	...
	private int _bit;
	private SC_WEAPON_MASTERY_ROULETTE_SLOT_OPEN_NOTI(){
		set_bonus_id(0);
	}
	...
	public int getSerializedSize(){
		...
		if (has_bonus_id()){
			size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeInt32Size(3, _bonus_id);
		}
