...
public class CS_INDUN_MATCHING_REGISTER_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_INDUN_MATCHING_REGISTER_REQ newInstance() {
		return new CS_INDUN_MATCHING_REGISTER_REQ();
	}
	...
	private CS_INDUN_MATCHING_REGISTER_REQ() {
	}
