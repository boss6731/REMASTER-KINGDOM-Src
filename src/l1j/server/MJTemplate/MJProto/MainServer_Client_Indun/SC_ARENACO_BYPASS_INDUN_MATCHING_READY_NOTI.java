...
public class SC_ARENACO_BYPASS_INDUN_MATCHING_READY_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static SC_ARENACO_BYPASS_INDUN_MATCHING_READY_NOTI newInstance(){
		return new SC_ARENACO_BYPASS_INDUN_MATCHING_READY_NOTI();
	}
	private eArenaMapKind _map_kind;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private SC_ARENACO_BYPASS_INDUN_MATCHING_READY_NOTI(){
	}
