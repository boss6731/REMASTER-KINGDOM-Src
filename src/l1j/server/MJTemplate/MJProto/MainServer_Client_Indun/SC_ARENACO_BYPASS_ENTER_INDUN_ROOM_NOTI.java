...
public class SC_ARENACO_BYPASS_ENTER_INDUN_ROOM_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_ARENACO_BYPASS_ENTER_INDUN_ROOM_NOTI newInstance() {
		return new SC_ARENACO_BYPASS_ENTER_INDUN_ROOM_NOTI();
	}
	...
	private SC_ARENACO_BYPASS_ENTER_INDUN_ROOM_NOTI() {
	}
