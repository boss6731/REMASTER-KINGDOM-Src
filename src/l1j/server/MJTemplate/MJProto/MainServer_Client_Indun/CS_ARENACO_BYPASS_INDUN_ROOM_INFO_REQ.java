...
public class CS_ARENACO_BYPASS_INDUN_ROOM_INFO_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_ARENACO_BYPASS_INDUN_ROOM_INFO_REQ newInstance() {
		return new CS_ARENACO_BYPASS_INDUN_ROOM_INFO_REQ();
	}
	...
	private CS_ARENACO_BYPASS_INDUN_ROOM_INFO_REQ() {
	}
