...
public class CS_INDUN_INVITE_LIST_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_INDUN_INVITE_LIST_REQ newInstance() {
		return new CS_INDUN_INVITE_LIST_REQ();
	}
	...
	private CS_INDUN_INVITE_LIST_REQ() {
	}
