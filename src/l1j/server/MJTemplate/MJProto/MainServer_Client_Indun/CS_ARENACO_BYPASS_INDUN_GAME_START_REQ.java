...
public class CS_ARENACO_BYPASS_INDUN_GAME_START_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_ARENACO_BYPASS_INDUN_GAME_START_REQ newInstance() {
		return new CS_ARENACO_BYPASS_INDUN_GAME_START_REQ();
	}
	...
	private CS_ARENACO_BYPASS_INDUN_GAME_START_REQ() {
	}
	...
	public int getSerializedSize() {
		...
		if (has_user_level()) {
			size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeUInt32Size(3, _user_level);
		}
	...
	public void writeTo(l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream output) throws java.io.IOException {
		...
		if (has_user_level()) {
			output.writeUInt32(3, _user_level);
		}
	}
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.server.GameClient clnt, byte[] bytes) {
		...
		try {
			...
			MJIndunRoomController.getInstance().onGameStart(pc, this);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return this;
