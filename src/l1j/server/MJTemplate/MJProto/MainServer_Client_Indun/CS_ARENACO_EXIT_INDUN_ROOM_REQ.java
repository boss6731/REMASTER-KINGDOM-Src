...
public class CS_ARENACO_EXIT_INDUN_ROOM_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_ARENACO_EXIT_INDUN_ROOM_REQ newInstance() {
		return new CS_ARENACO_EXIT_INDUN_ROOM_REQ();
	}
	...
	private CS_ARENACO_EXIT_INDUN_ROOM_REQ() {
	}
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.server.GameClient clnt, byte[] bytes) {
		...
		try {
			...
			MJIndunRoomController.getInstance().onExitRoom(pc, this);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return this;
