...
public class SC_ARENACO_BYPASS_INDUN_KICK_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static SC_ARENACO_BYPASS_INDUN_KICK_NOTI newInstance(){
		return new SC_ARENACO_BYPASS_INDUN_KICK_NOTI();
	}
	private int _room_id;
	private long _kick_arena_char_id;
	private byte[] _kick_char_name;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private SC_ARENACO_BYPASS_INDUN_KICK_NOTI(){
	}
	...
	public byte[] get_kick_char_name(){
		return _kick_char_name;
	}
	public void set_kick_char_name(byte[] val){
		_bit |= 0x4;
		_kick_char_name = val;
	}
	public boolean has_kick_char_name(){
		return (_bit & 0x4) == 0x4;
	}
	@Override
	...
	public int getSerializedSize(){
		...
		if (has_kick_char_name()){
			size += l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream.computeBytesSize(3, _kick_char_name);
		}
	...
	public void writeTo(l1j.server.MJTemplate.MJProto.IO.ProtoOutputStream output) throws java.io.IOException{
		...
		if (has_kick_char_name()){
			output.writeBytes(3, _kick_char_name);
		}
	}
	@Override
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				...
				case 0x0000001A:{
					set_kick_char_name(input.readBytes());
					break;
				}
				default:{
					return this;
