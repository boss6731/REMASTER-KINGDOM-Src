...
public class CS_INDUN_MATCHING_CANCEL_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_INDUN_MATCHING_CANCEL_REQ newInstance() {
		return new CS_INDUN_MATCHING_CANCEL_REQ();
	}
	...
	private CS_INDUN_MATCHING_CANCEL_REQ() {
	}
