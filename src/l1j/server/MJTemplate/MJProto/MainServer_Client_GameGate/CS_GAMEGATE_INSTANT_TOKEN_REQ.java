...
//			System.out.println(MJHexHelper.toString(bytes, bytes.length));
			...
			SC_GAMEGATE_INSTANT_TOKEN_NOTI noti = SC_GAMEGATE_INSTANT_TOKEN_NOTI.newInstance();
			noti.set_instant_token_id("NG1lbl9zZXJ2ZXI=");
			clnt.sendPacket(noti, MJEProtoMessages.SC_GAMEGATE_INSTANT_TOKEN_NOTI.toInt());
			*/
		} catch(Exception e){
			e.printStackTrace();
		}
