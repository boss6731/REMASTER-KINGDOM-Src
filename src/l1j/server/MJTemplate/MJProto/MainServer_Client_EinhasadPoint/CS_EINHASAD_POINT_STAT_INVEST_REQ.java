...
//					System.out.println(String.format("아인하사드 스탯 초과 : 중계기 사용 의심됨 캐릭명(%s) -클라오류 가능성-", pc.getName()));
//					return this;
//				}
//				
...
//			}
//
//			SC_EINHASAD_POINT_STAT_INVEST_ACK.send_point_stat_invest(pc, get_bless(), get_lucky(), get_vital());
