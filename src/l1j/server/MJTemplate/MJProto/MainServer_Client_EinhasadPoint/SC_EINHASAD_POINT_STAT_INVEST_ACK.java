...
public class SC_EINHASAD_POINT_STAT_INVEST_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static void send_point_stat_invest(L1PcInstance pc, int bless, int lucky, int vital) {
		SC_EINHASAD_POINT_STAT_INVEST_ACK noti = SC_EINHASAD_POINT_STAT_INVEST_ACK.newInstance();
		noti.set_bless(bless);
		noti.set_lucky(lucky);
		noti.set_vital(vital);
		pc.sendPackets(noti, MJEProtoMessages.SC_EINHASAD_POINT_STAT_INVEST_ACK, true);
	}

	public static SC_EINHASAD_POINT_STAT_INVEST_ACK newInstance() {
		return new SC_EINHASAD_POINT_STAT_INVEST_ACK();
	}
	...
	private SC_EINHASAD_POINT_STAT_INVEST_ACK() {
	}
