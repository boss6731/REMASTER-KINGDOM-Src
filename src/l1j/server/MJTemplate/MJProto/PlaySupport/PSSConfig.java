		...
		public enum GetOption{
			...
			public static GetOption fromInt(int i){
				...
				case 2:
					return ATTACK;
				default:
					throw new IllegalArgumentException(String.format("invalid arguments GetOption, %d", i));
				}
			}
		}
	}
	...
	public enum SetType{
		...
		public static SetType fromInt(int i){
			...
			case 2:
				return SURROUND;
			default:
				throw new IllegalArgumentException(String.format("invalid arguments SetType, %d", i));
			}
		}
	}
}
