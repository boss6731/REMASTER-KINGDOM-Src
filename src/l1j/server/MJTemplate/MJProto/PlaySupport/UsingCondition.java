	...
	public enum StateType{
		...
		public static StateType fromInt(int i){
			...
			case 21:
				return NONE;
			default:
				throw new IllegalArgumentException(String.format("invalid arguments StateType, %d", i));
			}
		}
	}
	public enum Operator{
		...
		public static Operator fromInt(int i){
			...
			case 2:
				return LESS_EQUAL;
			default:
				throw new IllegalArgumentException(String.format("invalid arguments Operator, %d", i));
			}
		}
	}
}
