...
public class RecommendPaths implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static RecommendPaths newInstance(){
		return new RecommendPaths();
	}
	private java.util.LinkedList<PathRecord> _PathRecords;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private RecommendPaths(){
	}
