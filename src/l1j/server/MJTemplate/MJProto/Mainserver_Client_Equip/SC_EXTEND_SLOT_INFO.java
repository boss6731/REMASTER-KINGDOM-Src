...
public class SC_EXTEND_SLOT_INFO implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static final int OPEN_SLOT_LRING			= 0x04;	// 왼쪽 반지.		4
	public static final int OPEN_SLOT_RRING			= 0x08;	// 오른쪽 반지.		8
	public static final int OPEN_SLOT_EARRING		= 0x10;	// 오른쪽 귀걸이.	16
	public static final int OPEN_SLOT_SHOULD 		= 0x40;	// 견갑 value.	64
	public static final int OPEN_SLOT_BADGE 		= 0x80;	// 휘장 value.	128
	public static final int OPEN_SLOT_LRING95 		= 0x100; // 95 왼쪽 반지.	256
	public static final int OPEN_SLOT_RRING100 		= 0x200; // 100오른쪽 반지.	512
	public static final int OPEN_SLOT_LEARRING101 	= 0x400; // 101왼쪽 귀걸이.	1024
	public static final int OPEN_SLOT_REARRING103 	= 0x800; // 103오른쪽 귀걸이.	2048
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				...
				case 0x00000012:{
					add_extend_slot_info((SC_EXTEND_SLOT_INFO.slotInfoT)input.readMessage(SC_EXTEND_SLOT_INFO.slotInfoT.newInstance()));
					break;
				}
				default:{
					return this;
