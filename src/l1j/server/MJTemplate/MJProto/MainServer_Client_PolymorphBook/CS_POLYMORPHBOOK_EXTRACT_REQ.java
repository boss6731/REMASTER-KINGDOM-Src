...
public class CS_POLYMORPHBOOK_EXTRACT_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static CS_POLYMORPHBOOK_EXTRACT_REQ newInstance(){
		return new CS_POLYMORPHBOOK_EXTRACT_REQ();
	}
	private int _Id;
	private int _Slot;
	...
	private int _bit;
	private CS_POLYMORPHBOOK_EXTRACT_REQ(){
	}
	public int get_Id(){
		return _Id;
	}
