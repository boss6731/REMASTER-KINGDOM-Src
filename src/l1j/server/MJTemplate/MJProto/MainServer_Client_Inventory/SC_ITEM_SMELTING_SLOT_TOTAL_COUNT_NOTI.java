...
public class SC_ITEM_SMELTING_SLOT_TOTAL_COUNT_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static SC_ITEM_SMELTING_SLOT_TOTAL_COUNT_NOTI newInstance(){
		return new SC_ITEM_SMELTING_SLOT_TOTAL_COUNT_NOTI();
	}
	...
	private int _bit;
	private SC_ITEM_SMELTING_SLOT_TOTAL_COUNT_NOTI(){
	}
