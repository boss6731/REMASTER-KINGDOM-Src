...
public class CS_SET_TOGGLE_INFO_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static CS_SET_TOGGLE_INFO_REQ newInstance(){
		return new CS_SET_TOGGLE_INFO_REQ();
	}
	...
	private int _bit;
	private CS_SET_TOGGLE_INFO_REQ(){
	}
