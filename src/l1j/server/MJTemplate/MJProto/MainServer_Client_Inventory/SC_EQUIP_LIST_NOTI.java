...
public class SC_EQUIP_LIST_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static SC_EQUIP_LIST_NOTI newInstance(){
		return new SC_EQUIP_LIST_NOTI();
	}
	private java.util.LinkedList<ItemEquipInfo> _item_equip_infos;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private SC_EQUIP_LIST_NOTI(){
	}
