...
public class CS_SMELTING_MAKE_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	private L1Item toInvalidOutputItem(L1PcInstance pc){
		System.out.println(String.format("[(��ü� �ռ�)Output�� ã�� �� �����ϴ�.] ĳ���� �̸� : %s, �ռ����̵� : %d", pc.getName(), _alchemy_id));
	...
	private CS_SMELTING_MAKE_REQ toInvalidAlchemyId(L1PcInstance pc){
		...
		System.out.println(String.format("[(��ü� �ռ�)Alchemy Id�� ã�� �� �����ϴ�.] ĳ���� �̸� : %s, �ռ����̵� : %d", pc.getName(), _alchemy_id));
		return this;
	}
	...
	private CS_SMELTING_MAKE_REQ toInvalidInput(L1PcInstance pc){
		...
		System.out.println(String.format("[(��ü� �ռ�)Inputs�� ã�� �� �����ϴ�.] ĳ���� �̸� : %s, �ռ����̵� : %d, ĳ������ǲ������ : %d", pc.getName(), _alchemy_id, _inputs.size()));
		return this;
	}
	
	private CS_SMELTING_MAKE_REQ toInvalidInputForInventory(L1PcInstance pc){
		SC_SMELTING_MAKE_ACK.ResultCode.RC_ERROR_INVALID_INPUT.sendCachedMessage(pc);
		System.out.println(String.format("[(��ü� �ռ�)������ ������ ��ü� ������ �κ��丮���� ã�� �� �����ϴ�.] ĳ���� �̸� : %s, �ռ����̵� : %d", pc.getName(), _alchemy_id));
		...
		GeneralThreadPool.getInstance().schedule(new Runnable(){
			...
			public void run(){
				...
				try{
					...
					System.out.println(String.format("[(��ü� �ռ�)���� ����� ���� �ɸ��Ͱ� �����ϴ�.] ĳ���� �̸� : %s, �����۾��̵� : %d, ������ �̸� : %s", name, resultItemInstance.getItemId(), resultItemInstance.getName()));
...
//			System.out.println(resultItemTemplate.getItemId());
			...
			if(pc != null){
				System.out.println(String.format("[(��ü��ռ�)���� ����.]�ɸ��� �̸� : %s", pc.getName()));
