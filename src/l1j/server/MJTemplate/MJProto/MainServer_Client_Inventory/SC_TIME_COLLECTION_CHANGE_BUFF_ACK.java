...
public class SC_TIME_COLLECTION_CHANGE_BUFF_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static void send(L1PcInstance pc, L1TimeCollectionUser user) {
		SC_TIME_COLLECTION_CHANGE_BUFF_ACK ack = SC_TIME_COLLECTION_CHANGE_BUFF_ACK.newInstance();
		ack.set_result(0x00);
		ack.set_groupID(user.getType().getType());
		ack.set_setID(user.getCollectionIndex());
		ack.set_buffType(user.getBuffType().getType());
		
		pc.sendPackets(ack, MJEProtoMessages.SC_TIME_COLLECTION_CHANGE_BUFF_ACK, true);
	}
	public static SC_TIME_COLLECTION_CHANGE_BUFF_ACK newInstance(){
		return new SC_TIME_COLLECTION_CHANGE_BUFF_ACK();
	}
	private int _result;
	...
	private int _bit;
	private SC_TIME_COLLECTION_CHANGE_BUFF_ACK(){
	}
