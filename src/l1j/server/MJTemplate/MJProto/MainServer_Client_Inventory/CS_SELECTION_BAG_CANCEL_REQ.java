...
public class CS_SELECTION_BAG_CANCEL_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static CS_SELECTION_BAG_CANCEL_REQ newInstance(){
		return new CS_SELECTION_BAG_CANCEL_REQ();
	}
	private int _bag_obj_id;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private CS_SELECTION_BAG_CANCEL_REQ(){
	}
