...
public class CS_HUNTING_GUIDE_BOOK_MAP_INFO_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static CS_HUNTING_GUIDE_BOOK_MAP_INFO_REQ newInstance(){
		return new CS_HUNTING_GUIDE_BOOK_MAP_INFO_REQ();
	}
	private int _map_number;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private CS_HUNTING_GUIDE_BOOK_MAP_INFO_REQ(){
	}
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.server.GameClient clnt, byte[] bytes){
		...
		try{
			...
			CPMWBQSystemProvider.provider().BQMapInfo(pc, this);
