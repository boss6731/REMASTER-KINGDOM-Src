...
public class SC_HUNTING_GUIDE_BOOKMARK_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				case 0x0000000A:{
					add_bookmarks((SC_HUNTING_GUIDE_BOOKMARK_NOTI.HUNTING_GUIDE_BOOKMARK_DATA)input.readMessage(SC_HUNTING_GUIDE_BOOKMARK_NOTI.HUNTING_GUIDE_BOOKMARK_DATA.newInstance()));
					break;
				}
				default:{
					return this;
