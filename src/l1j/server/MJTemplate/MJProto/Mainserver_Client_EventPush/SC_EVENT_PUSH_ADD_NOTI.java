...
//		CharBuffer cbuffer;
//		try {
//			cbuffer = CharBuffer.wrap((new String(subject.getBytes(), "EUC-KR")).toCharArray());
...
//		}
		...
		einfo.set_item_extra_desc(model.isUseitem_at_once() ? "아인하사드 축복 보너스".getBytes() : item.getName().getBytes());
		//try {0
