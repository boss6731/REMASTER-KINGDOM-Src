...
public class SC_EVENT_PUSH_LIST_STATUS_READ_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	...
	public static SC_EVENT_PUSH_LIST_STATUS_READ_ACK newInstance(L1PcInstance pc,
			CS_EVENT_PUSH_LIST_STATUS_READ_REQ req) {
		...
		pc.sendPackets(SC_EVENT_PUSH_UPDATE_INTO_LIST_ACK.make_stream(pc, (int) key.get_event_push_id(),
				key.get_reset_num(), 1));
		return noti;
	}
