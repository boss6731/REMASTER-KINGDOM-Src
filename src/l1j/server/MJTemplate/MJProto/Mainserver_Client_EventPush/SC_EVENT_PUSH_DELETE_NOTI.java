...
public class SC_EVENT_PUSH_DELETE_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static SC_EVENT_PUSH_DELETE_NOTI newInstance() {
		return new SC_EVENT_PUSH_DELETE_NOTI();
	}
	...
	private SC_EVENT_PUSH_DELETE_NOTI() {
	}
