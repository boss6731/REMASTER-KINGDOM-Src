...
public class CS_EVENT_PUSH_LIST_STATUS_DELETE_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static CS_EVENT_PUSH_LIST_STATUS_DELETE_REQ newInstance() {
		return new CS_EVENT_PUSH_LIST_STATUS_DELETE_REQ();
	}
	...
	private CS_EVENT_PUSH_LIST_STATUS_DELETE_REQ() {
	}
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.server.GameClient clnt, byte[] bytes) {
		...
		try {
			...
			MJPushProvider.provider().delete_push(pc, this);
