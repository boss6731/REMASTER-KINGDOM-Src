...
public enum EventPushResultCode {
	...
	EVENT_PUSH_SERVER_ERROR_INVALID_PARAM(19),
	EVENT_PUSH_ITEMS_ALREADY_BEING_RECIEVED(20),
	EVENT_PUSH_SYSTEM_ALREADY_DELETE(21),
	;;
	...
	public static EventPushResultCode fromInt(int i) {
		switch (i) {
			...
			case 19:
				return EVENT_PUSH_SERVER_ERROR_INVALID_PARAM;
			case 20:
				return EVENT_PUSH_ITEMS_ALREADY_BEING_RECIEVED;
			case 21:
				return EVENT_PUSH_SYSTEM_ALREADY_DELETE;
			default:
				throw new IllegalArgumentException(String.format("無效參數 EventPushResultCode，%d", i));
		}
	}
}
