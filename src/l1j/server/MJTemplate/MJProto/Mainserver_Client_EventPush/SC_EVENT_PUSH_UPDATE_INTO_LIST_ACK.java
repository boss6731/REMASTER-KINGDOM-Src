...
public class SC_EVENT_PUSH_UPDATE_INTO_LIST_ACK implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	...
	public static SC_EVENT_PUSH_UPDATE_INTO_LIST_ACK newInstance(L1PcInstance pc, int push_id, int reset_num, int state) {
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.MJTemplate.MJProto.IO.ProtoInputStream input) throws java.io.IOException{
		while(!input.isAtEnd()){
			...
			switch(tag){
				...
				case 0x00000012:{
					add_event_push_update_info_list((EventPushUpdateInfo)input.readMessage(EventPushUpdateInfo.newInstance()));
					break;
				}
				default:{
					return this;
