...
public class CS_BLOOD_PLEDGE_JOIN_LIMIT_USER_ADD_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static CS_BLOOD_PLEDGE_JOIN_LIMIT_USER_ADD_REQ newInstance(){
		return new CS_BLOOD_PLEDGE_JOIN_LIMIT_USER_ADD_REQ();
	}
	private String _add_user_name;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private CS_BLOOD_PLEDGE_JOIN_LIMIT_USER_ADD_REQ(){
	}
	...
	public l1j.server.MJTemplate.MJProto.MJIProtoMessage readFrom(l1j.server.server.GameClient clnt, byte[] bytes){
		...
		try{
			...
			System.out.println(get_add_user_name());
			// TODO : 아래부터 처리 코드를 삽입하십시오. made by Nature.
			SC_BLOOD_PLEDGE_JOIN_LIMIT_USER_ADD_ACK.send(pc, get_add_user_name());
