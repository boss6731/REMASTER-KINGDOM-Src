...
public class SC_REST_EXP_INFO_NOTI implements l1j.server.MJTemplate.MJProto.MJIProtoMessage {
	public static final int EINHASAD_LIMIT 				= Config.Einhasad_item.EINHASAD_LIMIT;									// 아인하사드 최대 충전 범위
	public static final int EINHASAD_UNIT 				= Config.Einhasad_item.EINHASAD_UNIT;
	public static final int RE_DRAGON_DIAMOND_CHARGE	= Config.Einhasad_item.RE_DRAGON_DIAMOND_CHARGE 	* 	EINHASAD_UNIT;	// 아인하사드의 가호
	public static final int RE_DRAGON_DIAMOND_FINEST	= Config.Einhasad_item.RE_DRAGON_DIAMOND_FINEST 	* 	EINHASAD_UNIT;	// 최고급 드래곤 다이아 충전량
	public static final int RE_DRAGON_DIAMOND_ADVANCED	= Config.Einhasad_item.RE_DRAGON_DIAMOND_ADVANCED 	* 	EINHASAD_UNIT;	// 고급 드래곤 다이아 충전량
	public static final int RE_DRAGON_DIAMOND_NORMAL 	= Config.Einhasad_item.RE_DRAGON_DIAMOND_NORMAL 	* 	EINHASAD_UNIT;	// 드래곤 다이아 충전량
	public static final int RE_DRAGON_SAPPHIRE_NORMAL 	= Config.Einhasad_item.RE_DRAGON_SAPPHIRE_NORMAL 	* 	EINHASAD_UNIT;	// 드래곤의 사파이어 충전량
	public static final int RE_DRAGON_RUBY_NORMAL 		= Config.Einhasad_item.RE_DRAGON_RUBY_NORMAL 		* 	EINHASAD_UNIT;	// 드래곤 루비 충전량
	public static final int RE_DRAGON_DIAMOND_APPLE 	= Config.Einhasad_item.RE_DRAGON_DIAMOND_APPLE		* 	EINHASAD_UNIT;	// 드래곤 다이아 충전량
