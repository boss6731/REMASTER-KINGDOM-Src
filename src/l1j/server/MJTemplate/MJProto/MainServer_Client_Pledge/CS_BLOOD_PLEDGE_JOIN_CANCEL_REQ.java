...
public class CS_BLOOD_PLEDGE_JOIN_CANCEL_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static CS_BLOOD_PLEDGE_JOIN_CANCEL_REQ newInstance(){
		return new CS_BLOOD_PLEDGE_JOIN_CANCEL_REQ();
	}
	private int _pledge_uid;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private CS_BLOOD_PLEDGE_JOIN_CANCEL_REQ(){
	}
