...
public class CS_BLOOD_PLEDGE_PRE_JOIN_REQ implements l1j.server.MJTemplate.MJProto.MJIProtoMessage{
	public static CS_BLOOD_PLEDGE_PRE_JOIN_REQ newInstance(){
		return new CS_BLOOD_PLEDGE_PRE_JOIN_REQ();
	}
	private byte[] _pledge_name;
	private int _memorizedSerializedSize = -1;
	private byte _memorizedIsInitialized = -1;
	private int _bit;
	private CS_BLOOD_PLEDGE_PRE_JOIN_REQ(){
	}
