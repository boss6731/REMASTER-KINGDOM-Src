...
//				L1Teleport.teleport(summonChar, 32673, 32801, (short)9101, 2, true);
					summonChar.start_teleport(32673, 32801, 9101, 2, 18339, true, false);
					break;
				case 1:
					for (int i = 0; i < 3; i++) {
...
//				L1Teleport.teleport(summonChar, 32735, 32862, (short)9101, 2, true);
					summonChar.start_teleport(32735, 32862, 9101, 2, 18339, true, false);
					break;
				case 2:
					for (int i = 0; i < 3; i++) {
...
//				L1Teleport.teleport(summonChar, 32799, 32863, (short)9101, 2, true);
					summonChar.start_teleport(32799, 32863, 9101, 2, 18339, true, false);
			}
			...
			if (boundTime == 15)
//				L1Teleport.teleport(summonChar, 32582, 32927, (short)0, 4, true);
				summonChar.start_teleport(32582, 32927, 0, 5, 18339, true, false);
			else {
//				L1Teleport.teleport(summonChar, 32797, 32801, (short)9101, 4, true);
				summonChar.start_teleport(32797, 32801, 9101, 5, 18339, true, false);
			}
			ownEnd();
		}
	...
	private void oldinMSG(int i) {
		switch (i) {
			case 1:
				Broadcaster.broadcastPacket(oldin, new S_NpcChatPacket(oldin, "你現在正在被奧林所欺騙。", 0));
				break;
			case 2:
				Broadcaster.broadcastPacket(oldin, new S_NpcChatPacket(oldin, "不應該相信他！快點離開這艘船，回到說話之島吧！", 0));
		}
	}
	...
	private void ownEnd() {
		for (int i = 0; i < _mimikList.size(); i++) {
			if (!((L1NpcInstance) _mimikList.get(i)).isDead()) {
				...
				((L1NpcInstance) _mimikList.get(i)).setStatus(8);
