...
class OrimFight extends Thread {
	...
	private void oldinMSG(int i) {
		switch (i) {
			case 1:
				Broadcaster.broadcastPacket(oldin, new S_NpcChatPacket(oldin, "你現在被奧林欺騙了。", 0));
				break;
			case 2:
				Broadcaster.broadcastPacket(oldin, new S_NpcChatPacket(oldin, "不能相信他！快離開這艘船，回到說話島！", 0));
				break;
			// 可以根据需求添加更多case
		}
	}
