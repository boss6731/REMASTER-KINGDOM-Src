 ...
 *
 */
public class WhaleBossRoom implements Runnable {
	...
	private L1MonsterInstance boss_1;//‡œÌ˛À¯–∫
	...
	public WhaleBossRoom(int id, L1PcInstance pc){
		_mapnum = (short)id;
		this.pc = pc;
	}
	...
	public WhaleBossRoom(int mapid){
		_mapnum = mapid;
		MonsterList = new ArrayList<L1NpcInstance>();
		boss_1 = (L1MonsterInstance) L1SpawnUtil.spawnnpc(32794, 32796, (short) _mapnum, 7800269, 0, 0, 0);//ƒ∏∆æ ¿Ë
	...
	private void quit() {
		HOME_TELEPORT();
		Object_Delete();
		WhaleBossRoomSystem.getInstance().Reset(_mapnum);
		_close = true;
	}
