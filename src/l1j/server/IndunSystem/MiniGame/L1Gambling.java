			...
			for (L1Object l1object : L1World.getInstance().getObject()) {
				if (l1object instanceof L1NpcInstance) {
					...
					if (Npc.getNpcTemplate().get_npcId() == 400064) {
						...
						if (bettingmoney >= 500000) { // 額外
							String chat = "下注金額超過限制了，咕嚕！";
							player.sendPackets(new S_NpcChatPacket(dealer, chat, 0));
							player.broadcastPacket(new S_NpcChatPacket(dealer, chat, 0));
						}
						String chat = player.getName() + " 您已下注 " + bettingmoney + " 元。";
						player.sendPackets(new S_NpcChatPacket(dealer, chat, 0));
						player.broadcastPacket(new S_NpcChatPacket(dealer, chat, 0));
						Thread.sleep(1000);
						Thread.sleep(1000);
						Thread.sleep(1000);
						String chat2 = "單或雙 2 倍//// 1 到 6 數字 3 倍///請輸入單雙或數字";
			...
			for (L1Object l1object : L1World.getInstance().getObject()) {
				if (l1object instanceof L1NpcInstance) {
					...
					if (Npc.getNpcTemplate().get_npcId() == 400064) {
						...
						String chat11 = pc.getName() + " 您猜錯了，沒有獎金，請享受遊戲。";
						int gfxid = 3204 + random.nextInt(6);
						switch (type) {
						case 1:
							Thread.sleep(2000);
							String chat = pc.getName() + " 您選擇了單。如果走遠，遊戲將被取消。";
						...
						case 2:
							Thread.sleep(2000);
							String chat2 = pc.getName() + " 您選擇了雙。如果走遠，遊戲將被取消。";
						...
						case 3:
							Thread.sleep(2000);
							String chat3 = pc.getName() + " 您選擇了 1。如果走遠，遊戲將被取消。";
						...
						case 4:
							Thread.sleep(2000);
							String chat4 = pc.getName() + " 您選擇了 2。如果走遠，遊戲將被取消。";
						...
						case 5:
							Thread.sleep(2000);
							String chat5 = pc.getName() + " 您選擇了 3。如果走遠，遊戲將被取消。";
						...
						case 6:
							Thread.sleep(2000);
							String chat6 = pc.getName() + " 您選擇了 4。如果走遠，遊戲將被取消。";
						...
						case 7:
							Thread.sleep(2000);
							String chat7 = pc.getName() + " 您選擇了 5。如果走遠，遊戲將被取消。";
						...
						case 8:
							Thread.sleep(2000);
							String chat8 = pc.getName() + " 您選擇了 6。如果走遠，遊戲將被取消。";
