				...
				if (l1object instanceof L1NpcInstance) {
					...
					if (Npc.getNpcTemplate().get_npcId() == 300027){
						...
						if (bettingmoney >= 500000) {   // 添加
							String chat = "::警告::>超過下注金額，吞掉！<::>警告::";
							player.sendPackets(new S_NpcChatPacket(dealer, chat, 0));
							player.broadcastPacket(new S_NpcChatPacket(dealer, chat, 0));
						}
						String chat = player.getName() + " 您下注了 " + bettingmoney + " 投注幣~ 每猜中一隻獲得2倍獎勵~!";
						player.sendPackets(new S_NpcChatPacket(dealer, chat, 0));
						player.broadcastPacket(new S_NpcChatPacket(dealer, chat, 0));
						Thread.sleep(2000);
						String chat2 = "請說出您要下注的怪物名稱~！(熊怪, 長者, 野豬, 史巴托伊, 史萊姆, 骷髏, 狼人, 怪物眼, 兽人戰士)";
			...
			for (L1Object l1object : L1World.getInstance().getObject()) {
				if (l1object instanceof L1NpcInstance) {
					...
					if (Npc.getNpcTemplate().get_npcId() == 300027){
						L1NpcInstance dealer = Npc;
						String chat8 = "真的嗎？哈哈";
						String chat9 = "哦！好... 恭喜您... 已支付獎金...";
						String chat11 = "真可惜，哈哈。請在下一次機會再挑戰吧~!";
						...
						case 1:
							Thread.sleep(1000);
							String chat20 = "您下注在獸人戰士~ 如果走遠，遊戲將被取消！";
						...
						case 2:
							Thread.sleep(1000);
							String chat21 = "您下注在史巴托伊~ 如果走遠，遊戲將被取消！";
						...
						case 3:
							Thread.sleep(1000);
							String chat22 = "您下注在野豬~ 如果走遠，遊戲將被取消！";
						...
						case 4:
							Thread.sleep(1000);
							String chat23 = "您下注在史萊姆~ 如果走遠，遊戲將被取消！";
						...
						case 5:
							Thread.sleep(1000);
							String chat14 = "您下注在骷髏~ 如果走遠，遊戲將被取消！";
						...
						case 6:
							Thread.sleep(1000);
							String chat15 = "您下注在狼人~ 如果走遠，遊戲將被取消！";
						...
						case 7:
							Thread.sleep(1000);
							String chat16 = "您下注在熊地精~ 如果走遠，遊戲將被取消！";
						...
						case 8:
							Thread.sleep(1000);
							String chat17 = "您下注在長老~ 如果走遠，遊戲將被取消！";
						...
						case 9:
							Thread.sleep(1000);
							String chat18 = "您下注在怪物眼~ 如果走遠，遊戲將被取消！";
