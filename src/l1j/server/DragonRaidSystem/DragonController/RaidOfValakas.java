...
public class RaidOfValakas implements Runnable {
	...
	private void TownEffectCheck() {
		...
		if (Town_Effect == 0)
			spawn(33719 + rnd.nextInt(5), 32493 + rnd.nextInt(5), (short) 4, 0, 73201232, ActionCodes.ACTION_Appear,
					4500);
		if (Town_Effect == 5)
			spawn(33707 - rnd.nextInt(5), 32496 - rnd.nextInt(5), (short) 4, 0, 73201232, ActionCodes.ACTION_Appear,
					4500);
		if (Town_Effect == 10)
			spawn(33716 + rnd.nextInt(5), 32502 + rnd.nextInt(5), (short) 4, 0, 73201232, ActionCodes.ACTION_Appear,
					4500);
		if (Town_Effect == 15)
			spawn(33709 - rnd.nextInt(5), 32505 - rnd.nextInt(5), (short) 4, 0, 73201232, ActionCodes.ACTION_Appear,
					4500);
		if (Town_Effect == 20)
			spawn(33707 + rnd.nextInt(5), 32496 + rnd.nextInt(5), (short) 4, 0, 73201232, ActionCodes.ACTION_Appear,
					4500);
