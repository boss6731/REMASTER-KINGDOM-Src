...
public class RaidOfFafurion implements Runnable {
	DragonRaidSystemInfo dinfo = DragonRaidSystemLoader.find(2);
	...
	private int teleporter_id = 73201222;
	...
	public void Start() {
		...
		spawn(32692, 32825, (short) 61, 0, teleporter_id, ActionCodes.ACTION_Appear, 3600 * 1000);
	...
	private void TownEffectCheck() {
		if (Town_Effect == 0) {
			spawn(33598, 33249, (short) 4, 0, 73201226, ActionCodes.ACTION_Appear, 6000);
			spawn(33609, 33238, (short) 4, 0, 73201227, ActionCodes.ACTION_Appear, 6000);
			spawn(33594, 33253, (short) 4, 0, 73201228, ActionCodes.ACTION_Appear, 6000);
			spawn(33593, 33240, (short) 4, 0, 73201229, ActionCodes.ACTION_Appear, 6000);
			spawn(33607, 33254, (short) 4, 0, 73201230, ActionCodes.ACTION_Appear, 6000);
		}
