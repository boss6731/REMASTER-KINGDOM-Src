...
public class MJRankBuffLv8 extends MJRankBuff{
	...
	public MJRankBuffLv8(){
		...
		noti.set_spell_id(L1SkillId.RANK_BUFF_8_STR);
		noti.set_duration(1);
		noti.set_duration_show_type(eDurationShowType.TYPE_EFF_UNLIMIT);
		noti.set_on_icon_id(11219);
		noti.set_off_icon_id(11219);
...
//		noti.set_tooltip_str_id(5148);
		...
		noti.set_spell_id(L1SkillId.RANK_BUFF_8_DEX);
		noti.set_on_icon_id(11219);
		noti.set_off_icon_id(11219);
...
//		noti.set_tooltip_str_id(5149);
		...
		noti.set_spell_id(L1SkillId.RANK_BUFF_8_INT);
		noti.set_on_icon_id(11219);
		noti.set_off_icon_id(11219);
...
//		noti.set_tooltip_str_id(5150);
	...
	public void onBuff(SC_TOP_RANKER_NOTI rnk) {
		...
		case 8:
		case 9:
			pc.setSkillEffect(L1SkillId.RANK_BUFF_8_STR, -1);
			pc.sendPackets(_onBuffs_str, false);
			pc.getAbility().addAddedStr(1);
			break;
			
		case 2:
			pc.setSkillEffect(L1SkillId.RANK_BUFF_8_DEX, -1);
		...
		case 3:
		case 6:
			pc.setSkillEffect(L1SkillId.RANK_BUFF_8_INT, -1);
	...
	public void offBuff(SC_TOP_RANKER_NOTI rnk) {
		...
		if(pc.hasSkillEffect(L1SkillId.RANK_BUFF_8_STR)){
			pc.killSkillEffectTimer(L1SkillId.RANK_BUFF_8_STR);
			pc.sendPackets(_offBuffs_str, false);
			pc.getAbility().addAddedStr(-1);
		}
		if(pc.hasSkillEffect(L1SkillId.RANK_BUFF_8_DEX)){
			pc.killSkillEffectTimer(L1SkillId.RANK_BUFF_8_DEX);
			pc.sendPackets(_offBuffs_dex, false);
			pc.getAbility().addAddedDex(-1);
		}
		if(pc.hasSkillEffect(L1SkillId.RANK_BUFF_8_INT)){
			pc.killSkillEffectTimer(L1SkillId.RANK_BUFF_8_INT);
