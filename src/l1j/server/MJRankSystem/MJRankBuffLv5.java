...
public class MJRankBuffLv5 extends MJRankBuff{
...
//		noti.set_tooltip_str_id(5148);
		...
		noti.set_spell_id(L1SkillId.RANK_BUFF_5_DEX);
		noti.set_on_icon_id(10033);
		noti.set_off_icon_id(10033);
		noti.set_tooltip_str_id(5140);
//		noti.set_on_icon_id(7096);
//		noti.set_off_icon_id(7096);
//		noti.set_tooltip_str_id(5149);
		...
		noti.set_spell_id(L1SkillId.RANK_BUFF_5_INT);
		noti.set_on_icon_id(10033);
		noti.set_off_icon_id(10033);
		noti.set_tooltip_str_id(5141);
//		noti.set_on_icon_id(7096);
//		noti.set_off_icon_id(7096);
//		noti.set_tooltip_str_id(5150);
	...
	public void onBuff(SC_TOP_RANKER_NOTI rnk) {
		...
		case 8:
		case 9:
			pc.setSkillEffect(L1SkillId.RANK_BUFF_5_STR, -1);
			pc.sendPackets(_onBuffs_str, false);
			pc.getAbility().addAddedStr(1);
			break;
			
		case 2:
			pc.setSkillEffect(L1SkillId.RANK_BUFF_5_DEX, -1);
		...
		case 3:
		case 6:
			pc.setSkillEffect(L1SkillId.RANK_BUFF_5_INT, -1);
	...
	public void offBuff(SC_TOP_RANKER_NOTI rnk) {
		...
		if(pc.hasSkillEffect(L1SkillId.RANK_BUFF_5_STR)){
			pc.killSkillEffectTimer(L1SkillId.RANK_BUFF_5_STR);
			pc.sendPackets(_offBuffs_str, false);
			pc.getAbility().addAddedStr(-1);
		}
		if(pc.hasSkillEffect(L1SkillId.RANK_BUFF_5_DEX)){
			pc.killSkillEffectTimer(L1SkillId.RANK_BUFF_5_DEX);
			pc.sendPackets(_offBuffs_dex, false);
			pc.getAbility().addAddedDex(-1);
		}
		if(pc.hasSkillEffect(L1SkillId.RANK_BUFF_5_INT)){
			pc.killSkillEffectTimer(L1SkillId.RANK_BUFF_5_INT);
