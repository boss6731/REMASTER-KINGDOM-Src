	...
	public boolean onExpendiant(L1PcInstance pc){
		try{
			...
			if(_expendiant <= 0 || !MJRankLoadManager.MRK_SYS_ISON){
				pc.sendPackets("��ڿ� ���� ��ŷ �ý����� �ߴܵǾ� �ִ� �����Դϴ�.");
				return false;
			}
			
			if(pc.isGm()){
				pc.sendPackets("GM�� �ش� �������� ����� �� �����ϴ�.");
				return false;
			}
			...
			if(noti == null){
				...
				if(noti.get_total_ranker().get_rank() <= MJRankLoadManager.MRK_SYS_RANK_POTION){
					pc.sendPackets("�����Ϸ��� ��ŷ���� ���� ��ŷ�� �����ϴ�.");
					return false;
				}
			}
			
			pc.set_exp((_expendiant + 5));
			pc.sendPackets(String.format("%s���� ����ġ�� ��ŷ %d���� ����ġ�� ������ �˴ϴ�.", pc.getName(), MJRankLoadManager.MRK_SYS_RANK_POTION));
			return true;
		}catch(Exception e){
			e.printStackTrace();
			pc.sendPackets("��ڿ� ���� ��ŷ �ý����� �ߴܵǾ� �ִ� �����Դϴ�.");
