...
public enum EActionCodes {	
	...
	walk_spear_throw(121, 16D, 			ActionIntervalDecoratorFactory.CHA_WALK_DECORATOR, ActionIntervalDecoratorFactory.PC_WALK_DECORATOR, EActionConstruct.ACTION_TYPE_WALK),
	attack_spear_throw(122, 19D, 		ActionIntervalDecoratorFactory.CHA_ATT_DECORATOR, ActionIntervalDecoratorFactory.PC_ATT_DECORATOR, EActionConstruct.ACTION_TYPE_ATTACK),
	damage_spear_throw(123, 14D, 		ActionIntervalDecoratorFactory.CHA_ATT_DECORATOR, ActionIntervalDecoratorFactory.PC_ATT_DECORATOR, EActionConstruct.ACTION_TYPE_DAMAGE),
	breath_spear_throw(124, 32D, 		ActionIntervalDecoratorFactory.CHA_ATT_DECORATOR, ActionIntervalDecoratorFactory.PC_ATT_DECORATOR, EActionConstruct.ACTION_TYPE_BREATH),;
	...
	public boolean is_alt_attack(){
		return (action_type & EActionConstruct.ACTION_TYPE_ATTACK_ALT) == EActionConstruct.ACTION_TYPE_ATTACK_ALT;
	}
