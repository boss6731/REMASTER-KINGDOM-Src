...
public class S_NewCreateItem extends ServerBasePacket {
	...
	public static final int NEW_PACKET_10 = 1;
	private static final String S_NEWCREATEITEM = "[S] S_NewCreateItem";

	public static final int BUFF_WINDOW = 0x6e;  // BUFF_WINDOW 表示增益窗口
	public static final int TAM_POINT = 0x01c2;
	public static final int CASTLE_WAR_TIME_END = 0x44;// 尚未使用
	...
	public static final int ENCYCLOPEDIA = 0x30;
	public static final int QUEST_DIALOGUE = 0xb;
	public static final int QUEST = 0xd;
	public static final int QUEST_2 = 0x9;
	public static final int QUEST_3 = 0x3e;
	public static final int QUEST_4 = 0x6;
	public static final int NEW_PACKET_2 = 0x20;
	public static final int NEW_PACKET_3 = 0xe3;
	public static final int NEW_PACKET_4 = 0xe5;
	public static final int NEW_PACKET_5 = 0xe7;
	public static final int NEW_PACKET_6 = 0xe9;
	public static final int NEW_PACKET_7 = 0xea;
	public static final int NEW_PACKET_8 = 0x2f;
	public static final int NEW_PACKET_10 = 0x7e;
	public static final int NEW_PACKET_11 = 0x76;
	public static final int NEW_PACKET_12 = 0x77;
	...
	private void buildPacket(int type, boolean ck) {
		...
		switch (type) {
			 ...
			 * writeC(0);
			 * writeC(0x1a);
			 * writeC(0x04); // 原本 0x04 代表還有需要捕捉的數量，0x05 代表全部捕捉完成
			 * writeC(0x08);
			 * writeC(0x6d); // 換算成十進制後，在遊戲中顯示為對應的編號
			 * writeC(0x10);
			 * writeC(0x02); // 捕捉到的數量，原本是 0x4e
			 * writeC(0x10);
			 * writeC(0);
			 * writeC(0x1a); // 原本是 0x00
			 * writeC(0x05); // 原本 0x04 代表還有需要捕捉的數量，0x05 代表全部捕捉完成
			 * writeC(0x08);
			 * writeC(0xAA); // 換算成十進制後，在遊戲中顯示為對應的編號
			 * writeC(4);
			 * writeC(0x10);
			 * writeC(2);
			 * writeC(0);
	...
	public S_NewCreateItem(int type, int order, int sub_order, int count) {
		...
		writeH(type);
		switch (type) {
			case BUFF_WINDOW: // 255 / 65025 / 16581375 / 4228250625  // 這是 110
				writeC(8);
				writeC(2);
				writeC(16);
				writeC(224);
