...
public class S_EquipmentWindow extends l1j.server.server.serverpackets.ServerBasePacket {
	private static final String S_EQUIPMENTWINDOWS = "[S] S_EquipmentWindow";
	public static final byte EQUIPMENT_INDEX_HELM = 1; // 頭盔
	public static final byte EQUIPMENT_INDEX_ARMOR = 2; // 盔甲
	public static final byte EQUIPMENT_INDEX_T = 3; // T恤
	public static final byte EQUIPMENT_INDEX_CLOAK = 4; // 斗篷
	public static final byte EQUIPMENT_INDEX_PAIR = 5; // 護腿
