...
//						Long logouttime = Timestamp.valueOf(clanMember.getLastLogoutTime().toString()).getTime();
						writeD(logouttime / (30 * 1000L * 1000L));	//最後一次連接時間??
//					} else {
//						writeD(0x00);	//最後連接時間??
//					}
	/*				} else {
					...
					if (name.equalsIgnoreCase("管理")) {
						...
						writeD(0);
						writeC(0);
						writeD((System.currentTimeMillis() / 1000L)); // 創建註冊日期
						write8x(0, 2);
						writeD(0x00);
					}
				}
