...
public class S_EnchantRanking extends l1j.server.server.serverpackets.ServerBasePacket {
	...
	private void buildPacket(L1PcInstance pc, int number) {
		...
		switch (number) {
			...
			if (number == 1) { // 追加部分
				writeS("\n\r"
						+ "  第1名 " + "+" + enchantlvl[0] + " " + name[0] + "\n\r" + "  獲獎者 : " + name1[0] + "\n\r"
						+ "  第2名 " + "+" + enchantlvl[1] + " " + name[1] + "\n\r" + "  獲獎者 : " + name1[1] + "\n\r"
						+ "  第3名 " + "+" + enchantlvl[2] + " " + name[2] + "\n\r" + "  獲獎者 : " + name1[2] + "\n\r"
						+ "  第4名 " + "+" + enchantlvl[3] + " " + name[3] + "\n\r" + "  獲獎者 : " + name1[3] + "\n\r"
						+ "  第5名 " + "+" + enchantlvl[4] + " " + name[4] + "\n\r" + "  獲獎者 : " + name1[4] + "\n\r"
						+ "  第6名 " + "+" + enchantlvl[5] + " " + name[5] + "\n\r" + "  獲獎者 : " + name1[5] + "\n\r"
						+ "  第7名 " + "+" + enchantlvl[6] + " " + name[6] + "\n\r" + "  獲獎者 : " + name1[6] + "\n\r"
						+ "  第8名 " + "+" + enchantlvl[7] + " " + name[7] + "\n\r" + "  獲獎者 : " + name1[7] + "\n\r"
						+ "  第9名 " + "+" + enchantlvl[8] + " " + name[8] + "\n\r" + "  獲獎者 : " + name1[8] + "\n\r"
						+ " 第10名 " + "+" + enchantlvl[9] + " " + name[9] + "\n\r" + "  獲獎者 : " + name1[9] + "\n\r" + "      ");
			} else if (number == 2) { // 追加部分
				writeS("\n\r"
						+ "  第一名 " + "+" + armor[0] + " " + name[0] + "\n\r" + "  獲獎者 : " + name1[0] + "\n\r"
						+ "  第2名 " + "+" + armor[1] + " " + name[1] + "\n\r" + "  獲獎者 : " + name1[1] + "\n\r"
						+ "  第3名 " + "+" + armor[2] + " " + name[2] + "\n\r" + "  獲獎者 : " + name1[2] + "\n\r"
				...
				writeS("\n\r"
						...
						+ "  第8名 " + priaden[7] + "神秘的羽毛\n\r" + "  獲獎者 : " + name[7] + "\n\r"
						+ "  第9名 " + priaden[8] + "神秘的羽毛\n\r" + "  獲獎者 : " + name[8] + "\n\r"
						+ " 第10名 " + priaden[9] + "神秘的羽毛\n\r" + "  獲獎者 : " + name[9] + "\n\r" + "      ");
			} else if (number == 6) { // 追加部分
				writeS("\n\r"
						+ "  第一名 $ : " + priaden[0] + " 金幣\n\r" + "  帳號名稱 : " + name[0] + "\n\r"
						+ "  第2名 $ : " + priaden[1] + " 金幣\n\r" + "  帳號名稱 : " + name[1] + "\n\r"
						+ "  第3名 $ : " + priaden[2] + " 金幣\n\r" + "  帳號名稱 : " + name[2] + "\n\r"
