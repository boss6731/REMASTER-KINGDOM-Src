...
public class S_Party extends ServerBasePacket {
	 ...
	 * ======================
	 * ========================================================== 77 68 01
	 * (選項/類型/人數-不包括邀請的隊員) e4 eb 26 0f / 45 76 61 74 65 73 74 00 / 64 / 44 00
	 * 00 00 / 1a 80 / ef 7f (obj/名稱/計量表/地圖/x/y) b4 45 26 0f / 45 76 61 74 65
	 * 73 74 31 31 00 / 64 / 44 00 00 00 / 19 80 / ef 7f (obj/名稱/計量表/地圖/x/y)
	 * 3c
	 */
	...
	/*
	 * 69 : 向現有的隊員傳送新隊員的信息（不包括首隊的隊長）
	 * ================================
	 * ================================================ packetbox :119 長度 :24
	 * ====
	 * ======================================================================
	 * ====== 77 / 69 (選項/類型) b4 45 26 0f / 45 76 61 74 65 73 74 31 31 00 / 44 00
	 ...
	 * ========================
	 * ======================================================== 77 6e 03
	 * （選項/類型/隊員人數）8c d3 25 0f / 44 00 00 00 / 19 80 / f0 7f （obj/地圖/x/y）b4
