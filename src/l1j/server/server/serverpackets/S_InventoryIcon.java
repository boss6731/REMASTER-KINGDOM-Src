...
public class S_InventoryIcon extends ServerBasePacket {
	...
	static{
//		_skillIdToMsgIds.put(L1SkillId.ABSOLUTE_BLADE, 	new StrMessageId(4735, 0, 4742));
		_skillIdToMsgIds.put(L1SkillId.DEATH_HEAL, 		new StrMessageId(4737, 0, 4744));
//		_skillIdToMsgIds.put(L1SkillId.GRACE_AVATAR, 	new StrMessageId(4734, 0, 4741));
//		_skillIdToMsgIds.put(L1SkillId.SOUL_BARRIER, 	new StrMessageId(4736, 0, 4743));
//		_skillIdToMsgIds.put(L1SkillId.IMPACT, 			new StrMessageId(4761, 0, 4754));
//		_skillIdToMsgIds.put(L1SkillId.TITANL_RISING, 	new StrMessageId(4740, 0, 4747));
		_skillIdToMsgIds.put(L1SkillId.Tam_Fruit1, 		new StrMessageId(4181, 0, 0));
		_skillIdToMsgIds.put(L1SkillId.CUBE_OGRE, 		new StrMessageId(3074, 0, 0));
		_skillIdToMsgIds.put(L1SkillId.CUBE_GOLEM, 		new StrMessageId(3075, 0, 0));
		_skillIdToMsgIds.put(L1SkillId.CUBE_RICH, 		new StrMessageId(1348, 0, 0));
		_skillIdToMsgIds.put(L1SkillId.CUBE_AVATAR, 	new StrMessageId(3073, 0, 0));
//		_skillIdToMsgIds.put(L1SkillId.FOCUS_SPRITS, 	new StrMessageId(5272, 0, 5273));
		//TODO 怪物技能
		_skillIdToMsgIds.put(L1SkillId.DEATH_HEAL_Mob, 	new StrMessageId(4737, 0, 4744));
	...
	public static ProtoOutputStream icoEnd(int skillId){
		S_InventoryIcon s = new S_InventoryIcon();
		s.writeC(0x08);
		s.writeC(0x03);
		s.writeC(0x10);
