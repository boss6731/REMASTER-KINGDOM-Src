...
//		System.out.println(text_byte.length);
    ...
    public S_NewChat(L1PcInstance whisperFrom, int i, int chatType, String text, String name) {
    }

	public S_NewChat(L1PcInstance pc, int i, int i1, String text, String s) {
	}
