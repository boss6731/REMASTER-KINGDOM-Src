...
public class S_DisplayEffect extends ServerBasePacket {
	...
	public static final int     RINDVIOR_LIGHT_DISPLAY            = 0x04;    // 林德比奧閃電效果顯示
	public static final int     LIFECRY_DISPLAY                    = 0x05;    // 生存呼喊飽足效果
	public static final int     BLUE_BORDER_DISPLAY                = 0x06;    // 藍色邊框顯示效果
	public static final int     VALAKAS_BORDER_DISPLAY             = 0x07;    // 巴拉卡斯火焰邊框顯示效果
	public static final int     RINDVIOR_BORDER_DISPLAY         = 0x08;    // 林德比奧藍灰色邊框顯示效果
	public static final int     BLACK_DISPLAY                     = 0x0A;    // 畫面變黑顯示效果
	...
	public static ProtoOutputStream newInstance(int value){
