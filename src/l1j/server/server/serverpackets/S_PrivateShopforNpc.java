     ...
     public class S_PrivateShopforNpc
       extends ServerBasePacket
     {
       public S_PrivateShopforNpc(L1PcInstance pc, int objId, int type) {
         ...
         if (type == 0) {
           ...
           if (shop == null) {
             System.out.println("NPC 商店錯誤：數量" + npc.getNpcId() + " x :" + npc.getX() + " y :" + npc.getY() + " map :" + npc.getMapId());
             return;
           }
           ...
           for (int i = 0; i < size; i++) {
             ...
             if (dummy != null) {
               ...
               else if (shopItem.getCount() > 1) { writeS(dummy.getName() + " (" + shopItem.getCount() + ")"); }
