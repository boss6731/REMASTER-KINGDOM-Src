		...
		for (int i = 0; i < shopItems.size(); i++) {
			...
			if (template == null) {
				...
				byte[] status = dummy.getStatusBytes(pc);
				 if (status != null) {
		               // 0：無 2：移動 4：刪除 6：移動、刪除 8：增強 10：移動、增強 12：刪除、增強 14：移動、刪除、增強
		               int bit = 0;
		               ...
		               System.out.println("商品錯誤訊息通知 : " + dummy.getItemId());
		            }
			}
		}
		if (npcId == 7320121 || npcId == 7320085 || npcId == 73201211 || npcId == 73201212 || npcId == 73201213
				|| npcId == 73201214 || npcId == 73201215 || npcId == 73201216 || npcId == 73201217 || npcId == 73201218
				|| npcId == 73201219 || npcId == 8502049 || npcId == 2020700 || npcId == 2020701 || npcId == 2020702
				|| npcId == 2020703 || npcId == 2020704 || npcId == 2020705 || npcId == 2020706 || npcId == 2020707
				|| npcId == 2020708 || npcId == 2020709) {
			writeH(26532);// 商店購買標籤包圖片
		} else {
			writeH(0x07);// 商店購買標籤包圖片
		}
	}
