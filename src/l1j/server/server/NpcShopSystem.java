     ...
     public void run() {
       try {
         ...
         for (int i = 0; i < list.size(); i++) {
           ...
           Thread.sleep(30L);
           obj.setState(1);
           Broadcaster.broadcastPacket((L1Character)npc, (ServerBasePacket)new S_DoActionShop(npc.getId(), 70, shop.getShopName()));
           NpcShopSystem._shops.add(npc);
           Thread.sleep(10L);
         }
