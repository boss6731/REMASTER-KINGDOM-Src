...
public class C_FixWeaponList extends l1j.server.server.clientpackets.ClientBasePacket {

	private static final String C_FIX_WEAPON_LIST = "[C] C_FixWeaponList";

	public <GameClient> C_FixWeaponList(byte abyte0[], GameClient clientthread) {
		super(abyte0);
