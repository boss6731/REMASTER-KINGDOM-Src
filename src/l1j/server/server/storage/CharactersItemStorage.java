...
public abstract class CharactersItemStorage {
	...
	public abstract void updateItemBlessLevel(L1ItemInstance item) throws Exception;
	...
	public abstract void updateItemLevel(L1ItemInstance item) throws Exception;
	
	public abstract void updateHotelTowm(L1ItemInstance item) throws Exception;

	public abstract int getItemCount(int objId) throws Exception;
	
	public abstract void updateSupportItem(L1ItemInstance item) throws Exception;
	
	public abstract void updatecarving(L1ItemInstance item) throws Exception;
	
	public abstract void updateDollLevel(L1ItemInstance item) throws Exception;
	
	public abstract void updateDollValue(L1ItemInstance item) throws Exception;
	
	public abstract void updateBlessType(L1ItemInstance item) throws Exception;

	public abstract void updateBlessTypeValue(L1ItemInstance item) throws Exception;
	
	public abstract void updateSmeltingValue(L1ItemInstance item) throws Exception;
	
	public abstract void updateSmeltingItemId1(L1ItemInstance item) throws Exception;
	
	public abstract void updateSmeltingItemId2(L1ItemInstance item) throws Exception;
	
	public abstract void updateSmeltingKind1(L1ItemInstance item) throws Exception;
	
	public abstract void updateSmeltingKind2(L1ItemInstance item) throws Exception;
	
	public abstract void updateHalpasTime(L1ItemInstance item) throws Exception;
