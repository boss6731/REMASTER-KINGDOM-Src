...
public class L1CastleLocation {
	...
	/**
	 * °¡µð¾È Å¸¿ö, Å©¶ó¿îÀÇ ÁÂÇ¥·ÎºÎÅÍ castle_id¸¦ µ¹·ÁÁØ´Ù
	 */
	...
	/**
	 * Ú÷üÞò¦ïÒàòÜÂîÜîúî³Ï¡æ´£¨Ò®Ý»£©ãÀÜúðíî¤
	 */
	...
	/**
	 * ÐÆËà castleId Ú÷üÞîúî³Ï¡æ´£¨Ò®Ý»£©îÜñ¨øö
	 */
	...
	/*
	 * castle_id·ÎºÎÅÍ ±ÍÈ¯Ã³ÀÇ ÁÂÇ¥¸¦ ·£´ý¿¡ µ¹·ÁÁØ´Ù
	 */
	...
	/**
	 * ÐÆËà npcid Ú÷üÞ castle_id
	 *
	 * @param npcid
	 * @return
	 */
	public static int getCastleIdByNpcid(int npcid) {
		// Edenàò£ºEden èÝÏÐîïæ´
		// Kentàò£ºKent, Gludio
		// Windawoodàò£ºWood Bec, Oasis, Silver Knight Town
		// Giranàò£ºGiran, àãü¥ñýÓö
		// Heineàò£ºHeine
		// Dwarvenàò£ºãæâ¢õ½, ßÚä³÷², ßÚä³÷²õ½íö
		// Orcishàò£ºûýæûõ½
		// Diadé©ßÝ£ºÝ»ÝÂîúî³Ï¡æ´
	...
	// ó®Û°ÛöÚ÷üÞî¤ Eden ãÁÊàØßìéô¸ÌÚãæîÜáªáã¡££¨ÜôãÀãùãÁîÜáªáã£©
	...
	// ÜÁðíÊÀàòáªáãîÜ HashMap£¨éÄåÚßÂïÁ£©
	...
	// çèÍªüåî¤ GameServer#initialize ûú L1CastleTaxRateListener#onDayChanged ù¬ðàéÄ¡£
