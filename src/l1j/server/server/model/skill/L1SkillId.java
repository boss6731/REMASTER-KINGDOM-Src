...
import l1j.server.server.serverpackets.S_Pc_Login;
...
public class L1SkillId {
	...
	public static final int BlessingOfThePeak = 80004;
...
//	public static final int RANK_BUFF_9 = 3529;


//	public static final int RANK_BUFF_10_STR = 3530;
//	public static final int RANK_BUFF_10_DEX = 3531;
//	public static final int RANK_BUFF_10_INT = 3532;

//	public static final int RANK_BUFF_11_STR = 3533;
//	public static final int RANK_BUFF_11_DEX = 3534;
//	public static final int RANK_BUFF_11_INT = 3535;

	public static final int NarutoThankYouCandy = 80005;
	public static final int LevelUpBonus = 80007;
	public static final int DRAGON_PUPLE = 80008;
	public static final int DRAGON_TOPAZ = 80009;

	public static final int miso_Buff = 8132; // 米索菲亞: 成長
	public static final int miso_Buff1 = 8133; // 米索菲亞的防禦祝福
	public static final int miso_Buff2 = 8134; // 米索菲亞的攻擊祝福
	...
	public static final int cheonhaJangsaBuff = 1541; // 天下壯士增益

	public static final int SKILLS_BEGIN = 1;

	public static final int CLANBUFF_YES = 7789; // 血盟增益

	public static final int God_buff = 4914; // 黑死增益

	public static final int STATUS_PET_FOOD = 1019;

	public static final int NO_DIS = 60001; // 疊加解除

	public static final int DELAY = 9999; // 群體眩暈延遲

	public static final int jugunBuff = 10534; // 主君的增益

	public static final int pcBang_Buff = 777888; // 網咖增益
	public static final int deliciousPufferfish = 11176; // 看起來好吃的河豚
	public static final int suGyeong = 11177; // 水鏡
...
// 1級普通魔法
	...
	//    public static final int ADVANCE_SPIRIT = 79; // 變更為被動
	...
	//    public static final int SOLID_CARRIAGE = 90; // 變更為被動
	public static final int COUNTER_BARRIER = 91;
	public static final int ABSOLUTE_BLADE = 92;
	//    public static final int PRIDE = 93; // 變更為被動
	...
	//    public static final int BURNING_SPIRIT = 102; // 變更為被動
	...
	//    public static final int FINAL_BURN = 108; // 變更為被動
	public static final int DRESS_MIGHTY = 109;
	public static final int DRESS_DEXTERITY = 110;
	//    public static final int DRESS_EVASION = 111; // 變更為被動
	...
	//public static final int SHINING_ARMOR = 116;
	public static final int BRAVE_MENTAL = 117;
	//public static final int MAJESTY = 118;
//    public static final int AURA = 121; // 變更為被動
	...
	//    public static final int RESIST_ELEMENTAL = 138; // 變更為被動
	public static final int MAFR = 139;//5102
	...
	//public static final int ELVEN_STRIKE = 5114;
	...
	//TODO 龍騎士技能
//    public static final int DRAGON_SKIN = 181; // 龍之皮膚 // 變更為被動
	public static final int BURNING_SLASH = 182;
	public static final int DESTROY = 183; // 毀滅
	public static final int MAGMA_BREATH = 184;
	public static final int SCALES_EARTH_DRAGON = 185;
	public static final int BLOOD_LUST = 186; // 血之渴望
	...
	//    public static final int MORTAL_BODY = 191; // 變更為被動
	...
	public static final int BEHEMOTH = 5057; // 臨時
	public static final int CHAIN_REACTION = 5059; // 臨時
	...
	//    public static final int GIGANTIC = 226; // 變更為被動
	...
	//    public static final int DEMOLITION = 247; // 變更為被動
	public static final int TEMPEST = 5027
			;
//	public static final int TEMPEST = 247;
	//public static final int BERSERK = 5117;
...
//TODO 黃金槍騎技能
	...
	/** 修煉者食物 **/
	public static final int TRAINEE_BEEF_STEAK = 3080;
	public static final int TRAINEE_STEAMED_SALMON = 3081;
	public static final int TRAINEE_ROASTED_TURKEY = 3082;
	public static final int TRAINEE_CHICKEN_SOUP = 3083;

	public static final int ADEN_SPECIAL_STEAK = 3104;
	public static final int ADEN_SPECIAL_CANAPE = 3105;
	public static final int ADEN_SPECIAL_SALAD = 3106;
	public static final int ADEN_TOMATO_SOUP = 3107;
	public static final int BLESSED_ADEN_SPECIAL_STEAK = 3108;
	public static final int BLESSED_ADEN_SPECIAL_CANAPE = 3109;
	public static final int BLESSED_ADEN_SPECIAL_SALAD = 3110;
	public static final int BLESSED_ADEN_TOMATO_SOUP = 3111;


	public static final int COOKING_END = 3077;
	public static final int NARUTO_THANKSGIVING_CANDY = 3078;
...
//	public static final int EIN_GAHO = 13070;

	public static final int MOB_SLOW_18 = 30000; // 緩慢 18號動作
	public static final int MOB_SLOW_1 = 30001; // 緩慢 1號動作
	public static final int MOB_CURSEPARALYZ_19 = 30002; // 詛咒 19號動作
	public static final int MOB_COCA = 30003; // 可卡特里斯 冰凍攻擊
	public static final int MOB_BASILL = 30004; // 巴西利斯克 冰凍攻擊
	public static final int MOB_RANGESTUN_19 = 30005; // 範圍昏迷 19號動作
	public static final int MOB_RANGESTUN_18 = 30006; // 範圍昏迷 18號動作
	public static final int MOB_RANGESTUN_20 = 30010; // 範圍昏迷 20號動作
	public static final int MOB_SHOCKSTUN_30 = 30081; // 衝擊昏迷 30號動作
	public static final int Mob_RANGESTUN_30 = 40007; // 扎德斯凱 範圍昏迷 30號動作 <<新增
	public static final int MOB_CURSEPARALYZ_18 = 30007; // 詛咒 18號動作
	public static final int MOB_DISEASE_30 = 30008; // 疾病 30號動作
	public static final int MOB_WEAKNESS_1 = 30009; // 衰弱 1號動作
	public static final int MOB_DISEASE_1 = 30079; // 疾病 1號動作
	public static final int MOB_WINDSHACKLE_1 = 30084; // 風之枷鎖 1號動作

	public static final int ANTI_DISINTEGRATE = 50001; // 反瓦解
	...
	public static final int ANTI_FINAL_BURN = 50005; // 反終極燃燒
	public static final int COMA_A = 50006;
	public static final int COMA_B = 50007;
	public static final int ANTI_METEOR = 50008; // 反流星
	public static final int LINDBIOR_SPIRIT_EFFECT = 50009;
	public static final int BUFF_CRAY = 50011; // 克雷增益
	public static final int BUFF_Vala = 50013;

	/** 增益 帕普里安 薩爾 新增 **/
	public static final int BUFF_SAEL = 10499;
	public static final int BUFF_GUNTER = 120384;
	public static final int FEATHER_BUFF_A = 22000; // 運勢增益（非常好）
	public static final int FEATHER_BUFF_B = 22001; // 運勢增益（好）
	public static final int FEATHER_BUFF_C = 22002; // 運勢增益（普通）
	public static final int FEATHER_BUFF_D = 22003; // 運勢增益（差）
	public static final int SetBuff = 90008; // 設置增益

	/** 龍族更新相關技能 **/
	public static final int ANTA_MAAN = 7671; // 地龍之魔眼 7671
	public static final int FAFU_MAAN = 7672; // 水龍之魔眼 7672
	public static final int LIND_MAAN = 7673; // 風龍之魔眼 7673
	public static final int VALA_MAAN = 7674; // 火龍之魔眼 7674
	public static final int BIRTH_MAAN = 7675; // 誕生之魔眼 7675
	public static final int SHAPE_MAAN = 7676; // 形狀之魔眼 7676
	public static final int LIFE_MAAN = 7678; // 生命之魔眼 7678
	public static final int SIDE_OF_ME_BLESSING = 7679; // 另一個我的庇佑
	public static final int RE_START_BLESSING = 7680; // 再出發的庇佑
	public static final int NEW_START_BLESSING = 7681; // 新出發的庇佑
	public static final int LIFE_BLESSING = 7682; // 誕生的庇佑
	public static final int BLACK_DRAGON_MAAN = 7687; // 黑龍之魔眼
	public static final int NAVER_BLACK_DRAGON_MAAN = 7688; // 絕對的魔眼

	public static final int ANTA_MESSAGE_1 = 22020; // 安塔[龍言1 / 取消 + 麻痺 -> 球體
	public static final int ANTA_MESSAGE_2 = 22021; // 安塔[龍言2 / 祝福+毒/ 球體 模克! 肯
	public static final int ANTA_MESSAGE_3 = 22022; // 安塔[龍言3 / 左右拳+吼叫/ 球體 模克!
	public static final int ANTA_MESSAGE_4 = 22023; // 安塔[龍言4 / 拳擊+祝福/ 球體 模克! 肯
	public static final int ANTA_MESSAGE_5 = 22024; // 安塔[龍言5 / 吼叫+祝福/ 球體 模克!
	public static final int ANTA_MESSAGE_6 = 22025; // 安塔[龍言6 / 昏迷+跳躍/ 球體 模克!
	public static final int ANTA_MESSAGE_7 = 22026; // 安塔[龍言7 / 昏迷+痙攣/ 球體 模克!
	public static final int ANTA_MESSAGE_8 = 22027; // 安塔[龍言8 / 昏迷+腳踢+跳躍/ 球體 模克!
	public static final int ANTA_MESSAGE_9 = 22028; // 安塔[龍言9 / 武器+祝福/ 球體 模克!
	public static final int ANTA_MESSAGE_10 = 22029; // 安塔[龍言10 / 武器+麻痺/ 球體 模克!
	public static final int ANTA_CANCELLATION = 22030; // 安塔[範圍取消 / 6格 / 8名]
	public static final int ANTA_SHOCKSTUN = 22031; // 安塔[範圍昏迷 / 4格]
	public static final int ANTA_WEAPON_BREAK = 22032; // 安塔[範圍武器 / 4格]
	public static final int PREDICATEDELAY = 22033; // 龍言技能延遲
	public static final int PAP_FIVEPEARLBUFF = 22035; // 帕普[五色珍珠破壞增益]
	public static final int PAP_MAGICALPEARLBUFF = 22036; // 帕普[神秘五色珍珠破壞增益]
	public static final int PAP_DEATH_PORTION = 22037; // 帕普[死亡藥水增益]
	public static final int PAP_DEATH_HELL = 22038; // 帕普[死亡治療增益]
	public static final int PAP_REDUCE_HELL = 22039; // 帕普[減少治療增益]
	public static final int PAP_PREDICATE1 = 22041; // 帕普[龍言1:里奧塔! 皮洛伊 那! [五色珍珠
	public static final int PAP_PREDICATE3 = 22043; // 帕普[龍言3:里奧塔! 拉納 奧伊姆!
	public static final int PAP_PREDICATE5 = 22045; // 帕普[龍言5:里奧塔! 內納 烏努斯! [減少
	public static final int PAP_PREDICATE6 = 22046; // 帕普[龍言6:里奧塔! 特納 韋恩拉克! [死亡
	public static final int PAP_PREDICATE7 = 22047; // 帕普[龍言7:里奧塔! 拉納 蓬蓬! [取消
	public static final int PAP_PREDICATE8 = 22048; // 帕普[龍言8:里奧塔! 勒波 蓬蓬!
	public static final int PAP_PREDICATE9 = 22049; // 帕普[龍言9:里奧塔! 特納 隆迪爾! [尾巴
	public static final int PAP_PREDICATE11 = 22051; // 帕普[龍言11:里奧塔! 奧尼茲 韋恩拉克!
	public static final int PAP_PREDICATE12 = 22052; // 帕普[龍言12:里奧塔! 奧尼茲 庫斯溫
	public static final int ANTA_BUFF = 22015; // 安塔拉斯 血痕
	public static final int FAFU_BUFF = 22016; // 帕普里昂 血痕
	public static final int STATUS_DRAGON_PEARL = 22017; // 龍 珍珠
	public static final int EMERALD_YES = 22018; // 龍 祖母綠
	public static final int EMERALD_NO = 22019; // 龍 祖母綠
	public static final int RIND_BUFF = 22060;
	public static final int OMAN_CANCELLATION = 22056; // 傲慢BOSS 範圍取消
	public static final int ICE_ERUPTION = 22058; // 極限的武器 冰爆發

	public static final int RINDVIOR_WIND_SHACKLE = 7001; // 風之枷鎖
	public static final int RINDVIOR_PREDICATE_CANCELLATION = 7002; // 召喚回歸
	public static final int RINDVIOR_TORNADO_FORE = 7003; // 旋風 4個 全體魔法
	public static final int RINDVIOR_WEAPON = 7004; // 武器
	...
	// 新增
	public static final int MOB_DEATH_POTION = 707137; // 死亡藥水
	public static final int COMBO_BUFF = 85010; // 組合

	// 黑長老
	public static final int BLACKELDER_DEATH_POTION = 7030;
	public static final int BLACKELDER_DEATH_HELL = 7031;
	public static final int BLACKELDER = 7037; // [ 閃電 / 巫妖極光 / 黑魔法 ]

	// 沙漠首領 [ 範圍魔法 ]
	public static final int DESERT_SKILL1 = 7041; // 範圍詛咒麻痺
	public static final int DESERT_SKILL2 = 7042; // 範圍大地束縛
	public static final int DESERT_SKILL3 = 7043; // 範圍法力吸取
	public static final int DESERT_SKILL4 = 7044; // 範圍毒
	public static final int DESERT_SKILL5 = 7045; // 詛咒/衰老/黑暗/疾病/虛弱
	public static final int DESERT_SKILL6 = 7046; // 範圍黑暗
	public static final int DESERT_SKILL7 = 7047; // 範圍睡眠霧
	public static final int DESERT_SKILL8 = 7048; // 埃爾扎貝龍捲風
	public static final int DESERT_SKILL9 = 7049; // 埃爾扎貝召喚怪物
	public static final int DESERT_SKILL10 = 7050; // 埃爾扎貝龍捲風生成
	public static final int DESERT_SKILL11 = 707117; // 埃爾扎貝龍捲風(更新)
	public static final int erzabe_worms = 7040; // 埃爾扎貝爆發
	public static final int Sand_worms = 7055; // 沙蟲爆發
	public static final int Sand_worms1 = 7056; // 沙蟲爆發
	public static final int Sand_worms2 = 7057; // 沙蟲爆發
	public static final int Sand_worms3 = 7058; // 沙蟲爆發
	public static final int WIDE_ARMORBREAK = 7059; // 範圍護甲破碎
	public static final int BOSS_COUNTER_BARRIER = 7060; // 首領反擊屏障
	public static final int MOB_TRIPLE_ARROW = 10210; // 黑暗精靈三連箭
	public static final int MOB_TRIPLE_ARROW_PRISON = 10211; // 三連箭
	...
	public static final int MOB_SKILL_NEW = 707151; // 埃爾扎貝龍捲風(更新)
	...
	public static final int doctor_skills = 707187; // 광역 독
	...
	/** 美提斯的誠意湯料 **/
	public static final int MetisBlessingScroll = 3000128;
	public static final int MetisHomemadeDish = 3000129;
	public static final int MetisHomemadeSoup = 3000130;

	/** shaved ice **/
	public static final int StrengthBingsu = 10524;
	public static final int AgilityBingsu = 10525;
	public static final int KnowledgeBingsu = 10526;
	...
	public static final int MOB_CURSEPARALYZ1 = 707095; // 커스 18번모션
	...
	//public static final int MOB_BERSERKERS = 707098;

	// TODO 其他怪物
	public static final int MOB_Kurtz_Pack = 707108;

	// TODO 一般物品類
	public static final int WITCH_MANA_POTION = 70702; // 女巫魔力恢復劑
	public static final int WITCH_MANA_POTION1 = 70703; // 妖精的魔力水
	public static final int WEEK_BOX = 71000; // 週獎勵箱
	...
	public static final int DISEASE = 70704; // 疾病
	public static final int ICE_LANCE = 70705; // 冰槍
	...
	public static final int EINHASAD_GRACE = 7116; // 艾因哈薩德的庇佑
	...
	public static final int[] ASSASSNATIONS = new int[] {
			ASSASSINATION_LEVEL_1, ASSASSINATION_LEVEL_2
	};


	public static final int[] COMPANION_BUFFS = new int[]{
			GROW_LEAF, EIN_LEAF, HEAVEN_LEAF, PITULL_YEAGER_BARM, RABID_DOG_BLOOD
	};
	...
	public static final int LEVEL_UP_BONUS = 1;
	public static int DeliciousPufferfish;

	public static void offEinhasadPrimiumFlat(L1PcInstance pc) {
		if(pc.hasSkillEffect(EINHASAD_PRIMIUM_FLAT)) {
			return;
		}

		SC_SPELL_BUFF_NOTI noti = SC_SPELL_BUFF_NOTI.newInstance();
		noti.set_noti_type(eNotiType.END);
		noti.set_spell_id(EINHASAD_PRIMIUM_FLAT);
		noti.set_duration(0);
	...
	public static void onEinhasadPrimiumFlat(L1PcInstance pc) {
		...
		int remainSeconds = pc.getSkillEffectTimeSec(EINHASAD_PRIMIUM_FLAT);
		SC_SPELL_BUFF_NOTI noti = SC_SPELL_BUFF_NOTI.newInstance();
		SC_REST_EXP_INFO_NOTI.send(pc);
		...
		pc.sendPackets(noti, MJEProtoMessages.SC_SPELL_BUFF_NOTI.toInt(), true);
		/*pc.sendPackets(new S_PacketBox(S_PacketBox.GREEN_MESSAGE, String.format("[艾因哈薩德高級訂閱剩餘時間] %s\n訂閱期間祝福值不會減少並維持不變。", MJString.remainTimeString(remainSeconds))));
		  pc.sendPackets("\f3- 艾因哈薩德高級訂閱剩餘時間");
		  pc.sendPackets("\f3    艾因值維持不變且不減少。");
		  pc.sendPackets("\f3- 即使艾因值維持不變，也能獲得艾因點數！");*/
	}

	public static void offEinhasadGreatFlat(L1PcInstance pc) {
		if(pc.hasSkillEffect(EINHASAD_GREAT_FLAT)) {
			return;
		}
	...
	public static void onEinhasadGreatFlat(L1PcInstance pc) {
		...
		int remainSeconds = pc.getSkillEffectTimeSec(EINHASAD_GREAT_FLAT);
		SC_REST_EXP_INFO_NOTI.send(pc);
		SC_SPELL_BUFF_NOTI noti = SC_SPELL_BUFF_NOTI.newInstance();
		...
		/*        pc.sendPackets(new S_PacketBox(S_PacketBox.GREEN_MESSAGE, String.format("[艾因哈薩德偉大訂閱剩餘時間] %s\n若祝福值全部消耗(0%)，則維持(基本)效果。", MJString.remainTimeString(remainSeconds))));
		pc.sendPackets("\aN- 艾因哈薩德偉大訂閱剩餘時間");
		pc.sendPackets("\aN   若艾因值為1000，則會被消耗。");
		pc.sendPackets("\aN   當達到0%時，仍會維持基本的庇佑效果(基本)。");
		pc.sendPackets("\aN- 由於艾因值會被消耗，因此可以獲得艾因點數！");*/
	}
	...
	private static final HashMap<Integer, TamNotifyInfo> tamNotifier;
	static {
		tamNotifier = new HashMap<>();
		tamNotifier.put(Tam_Fruit1, new TamNotifyInfo(8265, 4181));
		tamNotifier.put(Tam_Fruit2, new TamNotifyInfo(8266, 4182));
		tamNotifier.put(Tam_Fruit3, new TamNotifyInfo(8267, 4183));
		tamNotifier.put(Tam_Fruit4, new TamNotifyInfo(8268, 5046));
		tamNotifier.put(Tam_Fruit5, new TamNotifyInfo(8269, 5047));
	}
	...
	public static void recycleTam(L1PcInstance pc) {
		...
		if (tamcount > 0) {
			...
			int newSkillId = -1;
			if (tamcount == 1) {
				newSkillId = Tam_Fruit1;
			} else if (tamcount == 2) {
				newSkillId = Tam_Fruit2;
			} else if (tamcount == 3) {
				newSkillId = Tam_Fruit3;
			} else if (tamcount == 4) {
				newSkillId = Tam_Fruit4;
			} else if (tamcount == 5) {
				newSkillId = Tam_Fruit5;
			}
			if(tamNotifier.containsKey(newSkillId)) {
				TamNotifyInfo nInfo = tamNotifier.get(newSkillId);
				pc.sendPackets(new S_NewCreateItem(S_NewCreateItem.BUFF_WINDOW, (int) tamtime / 1000, nInfo.iconid, nInfo.strid));
	...
	public static final int FREEZE_AFTER_DELAY = Integer.MAX_VALUE - 1;
	public static void onFreezeAfterDelay(L1PcInstance pc) {
		pc.setSkillEffect(FREEZE_AFTER_DELAY, Config.Login.STUNSPEEDHACK);
	}


	public static void onPcCafeBuff(L1PcInstance pc, long remainMillis) {// PC房增益登錄
		try {
			L1SkillUse.on_icons(pc, PC_CAFE, (int)(remainMillis / 1000));
//			pc.setSkillEffect(PC_CAFE, remainMillis);
	...
	public static void offPcCafeBuff(L1PcInstance pc) {
		try {
			L1SkillUse.off_icons(pc, PC_CAFE);
			SC_USER_START_SUNDRY_NOTI.send(pc, pc.isPcBuff());
			SC_GAMEGATE_PCCAFE_CHARGE_NOTI.send(pc, pc.isPcBuff());
			pc.sendPackets("龍之庇佑：PC網咖增益時間已過期。");
			pc.sendPackets(SC_NOTIFICATION_MESSAGE.make_stream("龍之庇佑：PC網咖增益時間已過期。", MJSimpleRgb.green(), 5));
			pc.addDamageReductionByArmor(-2);
			pc.addWeightReduction(-100);
			pc.sendPackets(new S_OwnCharStatus(pc));
		} catch (Exception e) {
	...
	//TODO 移動速度封包(緩速, 真珠等) 目前不使用
	public static void onMoveEffectHandle(final L1PcInstance owner) {
		GeneralThreadPool.getInstance().schedule(new Runnable() {
			@Override
			public void run() {
				onSlowHandle(owner);
				onHolyWalkHandler(owner);
				return new L1PcInstance[0];
			}
		}, 1000L);//更新時間
	}
	//TODO 移動速度封包(緩速, 真珠等，需另外新增移動速度封包)
	public static void onHolyWalkHandler(final L1PcInstance owner) {
		int seconds = owner.getSkillEffectTimeSec(L1SkillId.HOLY_WALK);
		if(seconds > 0) {
//			owner.sendPackets(new S_SkillBrave(owner.getId(), 4, seconds));
			owner.broadcastPacket(new S_SkillBrave(owner.getId(), 4, seconds));
		}
		seconds = owner.getSkillEffectTimeSec(L1SkillId.DANCING_BLADES);
		if(seconds > 0) {
//			owner.sendPackets(new S_SkillBrave(owner.getId(), 1, seconds));
			owner.broadcastPacket(new S_SkillBrave(owner.getId(), 1, seconds));
		}
		seconds = owner.getSkillEffectTimeSec(L1SkillId.MOVING_ACCELERATION);
		if(seconds > 0) {
//			owner.sendPackets(new S_SkillBrave(owner.getId(), 4, seconds));
			owner.broadcastPacket(new S_SkillBrave(owner.getId(), 4, seconds));
		}
		seconds = owner.getSkillEffectTimeSec(L1SkillId.FOCUS_WAVE);
		if(seconds > 0) {
//			owner.sendPackets(new S_SkillBrave(owner.getId(), 10, seconds));
			owner.broadcastPacket(new S_SkillBrave(owner.getId(), 10, seconds));
		}
		seconds = owner.getSkillEffectTimeSec(L1SkillId.HURRICANE);
		if(seconds > 0) {
//			owner.sendPackets(new S_SkillBrave(owner.getId(), 9, seconds));
			owner.broadcastPacket(new S_SkillBrave(owner.getId(), 9, seconds));
		}
		seconds = owner.getSkillEffectTimeSec(L1SkillId.SAND_STORM);
		if(seconds > 0) {
//			owner.sendPackets(new S_SkillBrave(owner.getId(), 1, seconds));
			owner.broadcastPacket(new S_SkillBrave(owner.getId(), 1, seconds));
		}
		seconds = owner.getSkillEffectTimeSec(L1SkillId.BLOOD_LUST);
		if(seconds > 0) {
//			owner.sendPackets(new S_SkillBrave(owner.getId(), 6, seconds));
			owner.broadcastPacket(new S_SkillBrave(owner.getId(), 6, seconds));
		}
		seconds = owner.getSkillEffectTimeSec(L1SkillId.STATUS_FRUIT);
		if(seconds > 0) {
//			owner.sendPackets(new S_SkillBrave(owner.getId(), owner.getBraveSpeed(), seconds));
			owner.broadcastPacket(new S_SkillBrave(owner.getId(), owner.getBraveSpeed(), seconds));
		}
		seconds = owner.getSkillEffectTimeSec(L1SkillId.STATUS_DRAGON_PEARL);
		if(seconds > 0) {
			S_Liquor packet = new S_Liquor(owner.getId(), 8);
			owner.sendPackets(packet, false);
			owner.broadcastPacket(packet);
//			DRAGON_PEARL_BUFF(owner);
			owner.sendPackets(new S_ServerMessage(1065, seconds));
		}
		if (owner.isFourgear()) {
	...
	public static void onSlowHandle(L1PcInstance owner) {
		...
		if(remainSeconds > 0) {
			owner.sendPackets(new S_SkillHaste(owner.getId(), 2, remainSeconds));
			owner.broadcastPacket(new S_SkillHaste(owner.getId(), 2, 0));
		}
	}
