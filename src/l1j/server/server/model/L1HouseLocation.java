 ...
 public class L1HouseLocation
 {
   ...
   private static final Point[] TELEPORT_LOC_GIRAN = new Point[] { new Point(33419, 32810), new Point(33343, 32723), new Point(33553, 32712), new Point(32702, 32842) };



   private static final Point[] TELEPORT_LOC_HEINE = new Point[] { new Point(33604, 33236), new Point(33649, 33413), new Point(33553, 32712), new Point(32702, 32842) };




   private static final Point[] TELEPORT_LOC_ADEN = new Point[] { new Point(33928, 33347), new Point(33921, 33177), new Point(33553, 32712), new Point(32702, 32842) };



   private static final Point[] TELEPORT_LOC_GLUDIN = new Point[] { new Point(32628, 32807), new Point(32623, 32729), new Point(33553, 32712), new Point(32702, 32842) };
   ...
   public static boolean isRegenLoc(L1PcInstance pc, int locx, int locy, short mapid) {
     ...
     if (ls >= 65374 && ls <= 65408 && lm >= -734 && lm <= -701 && mapid == 4 && pc
       .isElf()) {
       ret = true;
     }
     else if (ls >= 65638 && ls <= 65672 && lm >= 78 && lm <= 112 && mapid == 613) {

       ret = true;
     }
     else if (ls >= 65649 && ls <= 65679 && lm >= 47 && lm <= 76 && mapid == 1001 && pc
       .isBlackwizard()) {
       ret = true;
     }
     else if (ls >= 65649 && ls <= 65679 && lm >= 49 && lm <= 78 && mapid == 1001 && pc
       .isDragonknight()) {
       ret = true;
     }
   ...
   public static boolean isInHouseLoc(int houseId, int locx, int locy, short mapid) {
     ...
     switch (houseId) {
       ...
       case 262153:
         ...
         break;
       case 262154:
         if ((locx >= 33421 && locx <= 33433 && locy >= 32685 && locy <= 32692 && mapid == 4) || mapid == 5077)
         {
       ...
       case 327683:
         ...
         break;
       case 327684:
         if ((locx >= 33628 && locx <= 33636 && locy >= 33241 && locy <= 33244 && mapid == 4) || (locx >= 33632 && locx <= 33635 && locy >= 33245 && locy <= 33250 && mapid == 4) || (locx >= 33634 && locx <= 33634 && locy >= 33251 && locy <= 33252 && mapid == 4) || mapid == 5116)
         {
       ...
       case 327687:
         ...
         break;
       case 327688:
         if ((locx >= 33577 && locx <= 33578 && locy >= 33337 && locy <= 33337 && mapid == 4) || (locx >= 33579 && locx <= 33588 && locy >= 33335 && locy <= 33339 && mapid == 4) || (locx >= 33585 && locx <= 33588 && locy >= 33340 && locy <= 33343 && mapid == 4) || mapid == 5120)
         {
         ...
         break;
       case 327689:
         if ((locx >= 33615 && locx <= 33623 && locy >= 33374 && locy <= 33377 && mapid == 4) || (locx >= 33619 && locx <= 33622 && locy >= 33378 && locy <= 33383 && mapid == 4) || (locx >= 33621 && locx <= 33621 && locy >= 33384 && locy <= 33385 && mapid == 4) || mapid == 5121)
         {
       ...
       case 327690:
         ...
         break;
       case 327691:
         if ((locx >= 33621 && locx <= 33622 && locy >= 33444 && locy <= 33444 && mapid == 4) || (locx >= 33622 && locx <= 33632 && locy >= 33442 && locy <= 33446 && mapid == 4) || (locx >= 33629 && locx <= 33632 && locy >= 33447 && locy <= 33450 && mapid == 4) || mapid == 5123)
         {
