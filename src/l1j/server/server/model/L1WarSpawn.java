...
public class L1WarSpawn {
	...
	public void SpawnTower(int castleId) {
		...
		if (castleId == 1)		//kent
			gfxId = 17622;
		else if (castleId == 2)	//orc
			gfxId = 17619;
		else if (castleId == 3)	//windawood
			gfxId = 10461;
		else if (castleId == 4)	//kiran
			gfxId = 17615;
		else if (castleId == 5)	//aden
			gfxId = 10469;
		else if (castleId == 6)	//dwarf
			gfxId = 10473;
		else if (castleId == 7)	//heine
			gfxId = 17920;
		else if (castleId == 8) //kent
			gfxId = 17622; 
