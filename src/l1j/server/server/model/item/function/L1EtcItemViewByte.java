...
public class L1EtcItemViewByte {
	...
	private static HashMap<Integer, L1EtcItemViewByte> _dataMap = new HashMap<Integer, L1EtcItemViewByte>();
	...
	public static L1EtcItemViewByte get(int itemId) {
		return (L1EtcItemViewByte) _dataMap.get(Integer.valueOf(itemId));
	}
	...
	private static void loadXml(HashMap<Integer, L1EtcItemViewByte> dataMap) {
		try {
			...
			_log.log(Level.SEVERE, "./data/xml/Item/EtcItemView.xmlload failed.", e);
		}
	}
	...
	public static void reload() {
		HashMap<Integer, L1EtcItemViewByte> dataMap = new HashMap<Integer, L1EtcItemViewByte>();
		loadXml(dataMap);
		_dataMap = dataMap;
	}
	...
	private static class ItemList implements Iterable<L1EtcItemViewByte> {
