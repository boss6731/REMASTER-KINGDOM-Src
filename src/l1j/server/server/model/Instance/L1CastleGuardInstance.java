   ...
   extends L1NpcInstance
 {
   ...
   public void searchTarget() {
    ...
    // 跳過當前 HP 為 0、死亡、GM 或幽靈玩家
       if (pc.getCurrentHp() <= 0 || pc.isDead() || pc.isGm() || pc.isGhost()) {
         continue;
       }
      // 檢查玩家是否不可見或 NPC 是否具有攻擊不可見的能力
