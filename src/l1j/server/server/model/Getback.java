...
//	}
	...
	public static void loadGetBack() {
		...
		try {
			...
			// 當同一地圖中混合了指定區域和未指定區域時，為了先讀取指定區域，使用 area_x1 降序排列
	 ...
	 * @return 一個數組，按順序包含locx, locy, mapid
	 */
