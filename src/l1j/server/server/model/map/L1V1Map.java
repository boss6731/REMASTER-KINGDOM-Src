...
public class L1V1Map extends L1Map {
	...
	public L1V1Map(int mapId, byte map[][], int worldTopLeftX, int worldTopLeftY, boolean underwater, boolean markable, boolean teleportable, boolean escapable, boolean useResurrection,
			boolean usePainwand, boolean enabledDeathPenalty, boolean takePets, boolean recallPets, boolean usableItem, boolean usableSkill, boolean isRuler, boolean isPCTEL, boolean crackinthetower) {
		_mapId = mapId;
		_baseMapId = mapId;
	...
	public L1V1Map clone(int id) {
		...
		map._is_ruler = _is_ruler;
		map._isPC_TEL = _isPC_TEL;
		map._is_Crackinthetower = _is_Crackinthetower;
		return map;
	}
	...
	public int getTestTile(int x, int y) {
		...
		System.out.println(_worldTopLeftX+"+"+_worldTopLeftY);
		return _map[x - _worldTopLeftX][y - _worldTopLeftY];
	}
