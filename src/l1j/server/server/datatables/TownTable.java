...
//
//        if( town.get_lastSaveTime() + 60 * 60 * 1000 < System.currentTimeMillis() ) // 每小時保存一次。
//        {
//            try {
//                con = L1DatabaseFactory.getInstance().getConnection();
//                pstm = con
//                        .prepareStatement("UPDATE town SET sales_money = ?, town_tax = ?, town_fix_tax = ? WHERE town_id = ?");
//                pstm.setInt(1, town.get_sales_money());
//                pstm.setInt(2, town.get_town_tax());
//                pstm.setInt(3, town.get_town_fix_tax());
//                pstm.setInt(4, town_id);
//                pstm.execute();
//
//                town.update_lastSaveTime();
//
