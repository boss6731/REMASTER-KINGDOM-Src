...
public class NewNpcChatTable {
	...
	private HashMap<Integer, L1NewNpcChat> _npcChatWalk = new HashMap<Integer, L1NewNpcChat>();
	private HashMap<Integer, L1NewNpcChat> _npcChatDead = new HashMap<Integer, L1NewNpcChat>();
	private HashMap<Integer, L1NewNpcChat> _npcChatHide = new HashMap<Integer, L1NewNpcChat>();
	private HashMap<Integer, L1NewNpcChat> _npcChatSpawn = new HashMap<Integer, L1NewNpcChat>();
	private HashMap<Integer, L1NewNpcChat> _npcChatEscape = new HashMap<Integer, L1NewNpcChat>();
	...
	private void FillNpcChatTable() {
		...
		try {
			...
			while (rs.next()) {
				...
				if (npcChat.getChatPosition() == L1NpcInstance.CHAT_TIMING_APPEARANCE) {
					_npcChatWalk.put(new Integer(npcChat.getNpcId()), npcChat);
				} else if (npcChat.getChatPosition() == L1NpcInstance.CHAT_TIMING_DEAD) {
					_npcChatDead.put(new Integer(npcChat.getNpcId()), npcChat);
				} else if (npcChat.getChatPosition() == L1NpcInstance.CHAT_TIMING_HIDE) {
					_npcChatHide.put(new Integer(npcChat.getNpcId()), npcChat);
				} else if (npcChat.getChatPosition() == L1NpcInstance.CHAT_TIMING_SPAWN) {
					_npcChatSpawn.put(new Integer(npcChat.getNpcId()), npcChat);
				} else if (npcChat.getChatPosition() == L1NpcInstance.CHAT_TIMING_ESCAPE) {
					_npcChatEscape.put(new Integer(npcChat.getNpcId()), npcChat);
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public L1NewNpcChat getTemplateWalk(int i) {
		return _npcChatWalk.get(new Integer(i));
	}
	...
	public L1NewNpcChat getTemplateSpawn(int i) {
		return _npcChatSpawn.get(new Integer(i));
	}
	
	public L1NewNpcChat getTemplateEscape(int i) {
		return _npcChatEscape.get(new Integer(i));
	}
}
