 ...
 public class SmeltingProbability {
   private static SmeltingProbability _instance;
   private HashMap<Integer, AlchemyProbStruct> _alchemy_structs;

   public static SmeltingProbability getInstance() {
     if (_instance == null)
       _instance = new SmeltingProbability();
     return _instance;
   }
   ...
   public static void reload() {
     SmeltingProbability old = _instance;
     _instance = new SmeltingProbability();
     if (old != null) {
       old.dispose();
       old = null;
   ...
   private HashMap<Integer, AlchemyProbStruct> load() {
     ...
     Selector.exec("select * from tb_smelting_probability", (SelectorHandler)new FullSelectorHandler()
         {
           public void result(ResultSet rs) throws Exception {
             while (rs.next()) {
               SmeltingProbability.AlchemyProbStruct struct = SmeltingProbability.AlchemyProbStruct.newInstance(rs);
   ...
   public Integer select_id(int alchemy_id) {
     return Integer.valueOf(MJSmeltingProbabilityBox.getInstance().nextCurrentAlchemyId(alchemy_id));
   }
