...
public class StringUtil {
	...
	public static String parse_money_string(int price){
		if(price >= 10000){
			...
			return thousand == 0 ? String.format("%,d萬", ten_thousand) : String.format("%,d萬%,d", ten_thousand, thousand);
		}
	...
	/**
	 * 在字節(byte)陣列中插入分隔符並連接。
	 * @param delimiter 分隔符
	 * @param args 陣列 {@code byte[]}
	 * @param radix 如果是 16，則轉換為十六進制
	 * @return 返回連接的字符串。
	 **/
	...
	/**
	 * 在陣列中插入分隔符並連接，不使用 char 而是轉換為 int。
	 * @param delimiter 分隔符
	 * @param args 陣列 {@code short[]}
	 * @param radix 如果是 16，則轉換為十六進制
	 * @return 返回連接的字符串。
	...
	/**
	 * 以 {title}{itemValue}{delimiter} 的形式連接 iterable。
	 * @param delimiter 分隔符
	 * @param title 每個項目附加的標題字符串
	 * @param iterable 要轉換的 {@code Iterable<T>}
	 * @param size 大小
	 * @return 轉換後的字符串
	 **/
	...
	/**
	 * 以 {title}{itemValue}{delimiter} 的形式連接 collection。
	 * @param delimiter 分隔符
	 * @param title 每個項目附加的標題字符串
	 * @param collection 要轉換的 {@code Collection<T>}
	 * @return 轉換後的字符串
	 **/
	...
	/**
	 * 以 {title}{key}={value}{delimiter} 的形式連接。
	 * @param delimiter 分隔符
	 * @param title 每個項目附加的標題字符串
	...
	/**
	 * 以 {title}{key}={value}{delimiter} 的形式連接 map。
	 * @param delimiter 分隔符
	 * @param title 每個項目附加的標題字符串
	 * @param map 要轉換的 {@code Map<K, V>}
	 * @return 轉換後的字符串
	 **/
	...
	/**
	 * 以 {title}{key}=[{value1, value2...}]{delimiter} 的形式連接。
	 * @param delimiter 分隔符
	 * @param title 每個項目附加的標題字符串
	 * @param iterable 要轉換的 Iterable{Map.Entry{K, List{V}}}
	 * @param size Iterable 的大小
	 * @param valuesDelimiter 用於 value 列表的分隔符
	 * @return 轉換後的字符串
	 **/
	 ...
	 * @param delimiter 分隔符
	 * @param title 每個項目附加的標題字符串
	 * @param entrySet 要轉換的 {@code Set<Map.Entry<K, List<V>>>}
	 * @param valuesDelimiter 用於值列表的分隔符
	 * @return 轉換後的字符串
	 **/
