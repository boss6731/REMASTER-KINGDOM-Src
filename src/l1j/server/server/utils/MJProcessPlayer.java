...
public class MJProcessPlayer {
	...
	public static String dumpLog(){
		...
		String path = String.format("dump\\[%02d-%02d-%02d]dump.txt", cal.get(Calendar.HOUR), cal.get(Calendar.MINUTE), cal.get(Calendar.SECOND));
		String[] command = new String[]{// TODO 必須確保Java版本一致，否則不會輸出
				"cmd", "/C", "C:\\Program Files\\Java\\jdk1.8.0_144\\bin\\jstack", getPid(), ">", 
				path
		};
