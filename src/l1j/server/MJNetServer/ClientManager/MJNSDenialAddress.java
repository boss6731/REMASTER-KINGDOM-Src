...
public class MJNSDenialAddress {
	public static final int REASON_WELL_KNWON = 0;			// 웰 노운 포트
	public static final int REASON_CONNECTION_OVER = 1;		// 커넥션 수 오버
	public static final int REASON_SIZE_OVER = 2;			// 패킷 사이즈 오버
	public static final int REASON_FILTER_HANDSHAKE = 3;	// 버전 핸드세이크
	public static final int REASON_WEB_URI_LENGTH_OVER = 4;	// 웹 uri길이 비정상
	public static final int REASON_WEB_ACCES_OVER = 5;		// 웹 과다 액세스
