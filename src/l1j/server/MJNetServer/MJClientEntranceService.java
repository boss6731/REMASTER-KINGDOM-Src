...
public class MJClientEntranceService {
	private static MJDTSElement AttributeKey;
	private static final AttributeKey<EntranceClientModel> entranceAttribute = MJDTSElement.newInstance("EntranceAttribute");
	...
	public static class EntranceClientModel{
		GameClient client;
		int waitSeconds;
		boolean waiting;
		boolean canceled;
