...
public class MJItemSkillModelLoader {
	...
	private MJItemSkillModel parseType(String type){
		...
		else if(type.equalsIgnoreCase("武器-混亂追加攻擊(無特效)"))
			return new Atk_Chaotic();
		else if(type.equalsIgnoreCase("武器-混亂追加攻擊(附加特效)"))
			return new Atk_ChaoticAndNormal();
		else if(type.equalsIgnoreCase("武器-傷害毒"))
			return new Atk_DamagePoison();
		else if(type.equalsIgnoreCase("武器-厄運匕首"))
			return new Atk_DiceDagger();
		else if(type.equalsIgnoreCase("武器-疾病"))
			return new Atk_Disease();
		else if(type.equalsIgnoreCase("武器-束縛"))
			return new Atk_Hold();
		else if(type.equalsIgnoreCase("武器-吸血"))
			return new Atk_HPDrain();
		else if(type.equalsIgnoreCase("武器-吸血(增加傷害)"))
			return new Atk_HPDrainAndGet();
		else if(type.equalsIgnoreCase("武器-吸魔"))
			return new Atk_MPDrain();
		else if(type.equalsIgnoreCase("武器-吸魔(增加傷害)"))
			return new Atk_MPDrainAndGet();
		else if(type.equalsIgnoreCase("武器-吸魔(疾病)"))
		...
		else if(type.equalsIgnoreCase("武器-驅散不死生物"))
			return new Atk_TurnUndead();
		else if(type.equalsIgnoreCase("武器-機率致命一擊"))
			return new Atk_CriticalAttack();
		else if(type.equalsIgnoreCase("武器-機率致命一擊(劍鬼)"))
		...
		else if(type.equalsIgnoreCase("防具-機率減傷"))
